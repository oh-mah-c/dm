...
**[156]** oh-mah-c, "OhmC2: A CPU-First Dual-Path Language Model with RealFormer Ring State and Per-Token KAN MoE Routing," dm repository, 2026. https://github.com/oh-mah-c/dm/tree/main/src/models/nlp/ohmc2 *(OhmC2 — CPU-first autoregressive LLM; dual-gate RealFormer attention + per-token hard-MoE KAN block; preallocated K/V and score caches; stable integer token IDs)*

**[157]** N. M. Atakishiyev, "On the eigenvectors of the 5D discrete Fourier transform number operator in Newtonian basis," arXiv:2501.00148v1, 2025. https://arxiv.org/abs/2501.00148 *(Ohm-Discrete-QHO — 5D discrete quantum harmonic oscillator; Askey-Wilson algebra; intertwining relations)*

**[158]** T. Creutzig, N. Genra, and S. Nakatsuka, "Generalized W-algebras and their finite analogues," arXiv:2501.00271v2, 2025. https://arxiv.org/abs/2501.00271 *(Ohm-STRING — Symbolic Lie Algebra Engine; non-commutative polynomials; PBW normal ordering)*

**[159]** X. Fang, "Quantum Birkhoff normal forms and their applications," arXiv:2501.05041v2, 2025. https://arxiv.org/abs/2501.05041 *(Ohm-QBNF — Quantum Birkhoff Normal Form; homological equation decomposition; Lie transform unitary generator)*
