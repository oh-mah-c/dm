...
$(BERT_TARGET): $(SRC_DIR)/tools/dm_bert.c $(SRC_DIR)/models/language/bert.c include/models/lm/bert.h
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) $(SRC_DIR)/tools/dm_bert.c $(SRC_DIR)/models/language/bert.c -o $@ $(LDFLAGS)
