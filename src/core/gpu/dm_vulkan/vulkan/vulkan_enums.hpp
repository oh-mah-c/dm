...
VULKAN_HPP_INLINE VULKAN_HPP_CONSTEXPR Flags<BitType> operator~( BitType bit ) VULKAN_HPP_NOEXCEPT
{
  ...
  template <> struct FlagTraits<DeviceQueueCreateFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR DeviceQueueCreateFlags allFlags = 
        ...
        | DeviceQueueCreateFlagBits::eInternallySynchronizedKHR;
  };
  ...
  template <> struct FlagTraits<PipelineLayoutCreateFlagBits>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PipelineLayoutCreateFlags allFlags = 
        ...
        | PipelineLayoutCreateFlagBits::eNoTaskShaderKHR;
  };
...
;
  ...
  enum class FormatFeatureFlagBits2 : VkFormatFeatureFlags2{
    ...
    eSampledImageYcbcrConversionChromaReconstructionExplicitForceableKHR = VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR,
  ...
  // wrapper using for bitmask VkGpaPerfBlockPropertiesFlagsAMD, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkGpaPerfBlockPropertiesFlagsAMD.html
  using GpaPerfBlockPropertiesFlagsAMD = Flags<GpaPerfBlockPropertiesFlagBitsAMD>;


  template <> struct FlagTraits<GpaPerfBlockPropertiesFlagBitsAMD>
  {
  ...
  // wrapper using for bitmask VkPhysicalDeviceGpaPropertiesFlagsAMD, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkPhysicalDeviceGpaPropertiesFlagsAMD.html
  using PhysicalDeviceGpaPropertiesFlagsAMD = Flags<PhysicalDeviceGpaPropertiesFlagBitsAMD>;


  template <> struct FlagTraits<PhysicalDeviceGpaPropertiesFlagBitsAMD>
  {
  ...
  template <> struct FlagTraits<PresentTimingInfoFlagBitsEXT>
  {
    using WrappedType = VkPresentTimingInfoFlagBitsEXT;
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR PresentTimingInfoFlagsEXT allFlags = 
          PresentTimingInfoFlagBitsEXT::ePresentAtRelativeTime
        | PresentTimingInfoFlagBitsEXT::ePresentAtNearestRefreshCycle;
  };

  // wrapper class for enum VkPastPresentationTimingFlagBitsEXT, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkPastPresentationTimingFlagBitsEXT.html
  ...
  // wrapper using for bitmask VkPastPresentationTimingFlagsEXT, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkPastPresentationTimingFlagsEXT.html
  using PastPresentationTimingFlagsEXT = Flags<PastPresentationTimingFlagBitsEXT>;


  template <> struct FlagTraits<PastPresentationTimingFlagBitsEXT>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PastPresentationTimingFlagsEXT allFlags = 
          PastPresentationTimingFlagBitsEXT::eAllowPartialResults
        | PastPresentationTimingFlagBitsEXT::eAllowOutOfOrderResults;
  };
  ...
  template <> struct FlagTraits<VideoEncodeFlagBitsKHR>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeFlagsKHR allFlags = 
          VideoEncodeFlagBitsKHR::eIntraRefresh
  ...
  // wrapper class for enum VkVideoEncodeRgbModelConversionFlagBitsVALVE, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeRgbModelConversionFlagBitsVALVE.html
  ...
  // wrapper using for bitmask VkVideoEncodeRgbModelConversionFlagsVALVE, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeRgbModelConversionFlagsVALVE.html
  using VideoEncodeRgbModelConversionFlagsVALVE = Flags<VideoEncodeRgbModelConversionFlagBitsVALVE>;


  template <> struct FlagTraits<VideoEncodeRgbModelConversionFlagBitsVALVE>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeRgbModelConversionFlagsVALVE allFlags = 
          VideoEncodeRgbModelConversionFlagBitsVALVE::eRgbIdentity
  ...
  // wrapper class for enum VkVideoEncodeRgbRangeCompressionFlagBitsVALVE, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeRgbRangeCompressionFlagBitsVALVE.html
  ...
  // wrapper using for bitmask VkVideoEncodeRgbRangeCompressionFlagsVALVE, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeRgbRangeCompressionFlagsVALVE.html
  using VideoEncodeRgbRangeCompressionFlagsVALVE = Flags<VideoEncodeRgbRangeCompressionFlagBitsVALVE>;


  template <> struct FlagTraits<VideoEncodeRgbRangeCompressionFlagBitsVALVE>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeRgbRangeCompressionFlagsVALVE allFlags = 
          VideoEncodeRgbRangeCompressionFlagBitsVALVE::eFullRange
        | VideoEncodeRgbRangeCompressionFlagBitsVALVE::eNarrowRange;
  };

  // wrapper class for enum VkVideoEncodeRgbChromaOffsetFlagBitsVALVE, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeRgbChromaOffsetFlagBitsVALVE.html
  ...
  // wrapper using for bitmask VkVideoEncodeRgbChromaOffsetFlagsVALVE, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeRgbChromaOffsetFlagsVALVE.html
  using VideoEncodeRgbChromaOffsetFlagsVALVE = Flags<VideoEncodeRgbChromaOffsetFlagBitsVALVE>;


  template <> struct FlagTraits<VideoEncodeRgbChromaOffsetFlagBitsVALVE>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeRgbChromaOffsetFlagsVALVE allFlags = 
          VideoEncodeRgbChromaOffsetFlagBitsVALVE::eCositedEven
        | VideoEncodeRgbChromaOffsetFlagBitsVALVE::eMidpoint;
  };
  ...
  template <> struct FlagTraits<PhysicalDeviceSchedulingControlsFlagBitsARM>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR PhysicalDeviceSchedulingControlsFlagsARM allFlags = 
        ...
        | PhysicalDeviceSchedulingControlsFlagBitsARM::eDispatchParameters;
  };
  ...
  template <> struct FlagTraits<PresentScalingFlagBitsKHR>
  {
    using WrappedType = VkPresentScalingFlagBitsKHR;
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR PresentScalingFlagsKHR allFlags = 
          PresentScalingFlagBitsKHR::eOneToOne
        | PresentScalingFlagBitsKHR::eAspectRatioStretch
  ...
  template <> struct FlagTraits<DataGraphPipelineSessionCreateFlagBitsARM>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR DataGraphPipelineSessionCreateFlagsARM allFlags = 
        ...
        | DataGraphPipelineSessionCreateFlagBitsARM::eOpticalFlowCache;
  };
  ...
  // wrapper class for enum VkDataGraphTOSAQualityFlagBitsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphTOSAQualityFlagBitsARM.html
  ...
  template <> struct FlagTraits<DataGraphTOSAQualityFlagBitsARM>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR DataGraphTOSAQualityFlagsARM allFlags = 
          DataGraphTOSAQualityFlagBitsARM::eAccelerated
  ...
  template <> struct FlagTraits<AddressCopyFlagBitsKHR>
  {
    using WrappedType = VkAddressCopyFlagBitsKHR;
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR AddressCopyFlagsKHR allFlags = 
          AddressCopyFlagBitsKHR::eDeviceLocal
        | AddressCopyFlagBitsKHR::eSparse
        | AddressCopyFlagBitsKHR::eProtected;
  };

  //=== VK_EXT_memory_decompression ===

  // wrapper class for enum VkMemoryDecompressionMethodFlagBitsEXT, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkMemoryDecompressionMethodFlagBitsEXT.html
  ...
  // wrapper using for bitmask VkMemoryDecompressionMethodFlagsEXT, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkMemoryDecompressionMethodFlagsEXT.html
  ...
  template <> struct FlagTraits<MemoryDecompressionMethodFlagBitsEXT>
  {
    using WrappedType = VkMemoryDecompressionMethodFlagBitsEXT;
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR MemoryDecompressionMethodFlagsEXT allFlags = 
          MemoryDecompressionMethodFlagBitsEXT::eGdeflate10;
  };
  ...
  // wrapper class for enum VkVideoEncodeIntraRefreshModeFlagBitsKHR, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeIntraRefreshModeFlagBitsKHR.html
  ...
  // wrapper using for bitmask VkVideoEncodeIntraRefreshModeFlagsKHR, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkVideoEncodeIntraRefreshModeFlagsKHR.html
  using VideoEncodeIntraRefreshModeFlagsKHR = Flags<VideoEncodeIntraRefreshModeFlagBitsKHR>;


  template <> struct FlagTraits<VideoEncodeIntraRefreshModeFlagBitsKHR>
  {
  ...
  // wrapper class for enum VkDeviceFaultVendorBinaryHeaderVersionKHR, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDeviceFaultVendorBinaryHeaderVersionKHR.html
  ...
  template <> struct FlagTraits<DeviceFaultFlagBitsKHR>
  {
    using WrappedType = VkDeviceFaultFlagBitsKHR;
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR DeviceFaultFlagsKHR allFlags = 
          DeviceFaultFlagBitsKHR::eFlagDeviceLost
  ...
  // wrapper class for enum VkRayTracingInvocationReorderModeEXT, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkRayTracingInvocationReorderModeEXT.html
  ...
  // wrapper using for bitmask VkPerformanceCounterDescriptionFlagsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkPerformanceCounterDescriptionFlagsARM.html
  using PerformanceCounterDescriptionFlagsARM = Flags<PerformanceCounterDescriptionFlagBitsARM>;


  template <> struct FlagTraits<PerformanceCounterDescriptionFlagBitsARM>
  {
  ...
  // wrapper using for bitmask VkShaderInstrumentationValuesFlagsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkShaderInstrumentationValuesFlagsARM.html
  using ShaderInstrumentationValuesFlagsARM = Flags<ShaderInstrumentationValuesFlagBitsARM>;


  template <> struct FlagTraits<ShaderInstrumentationValuesFlagBitsARM>
  {
  ...
  // wrapper class for enum VkOpacityMicromapSpecialIndexKHR, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkOpacityMicromapSpecialIndexKHR.html
  ...
  // wrapper class for enum VkAccelerationStructureSerializedBlockTypeKHR, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkAccelerationStructureSerializedBlockTypeKHR.html
  ...
  // wrapper class for enum VkRenderingAttachmentFlagBitsKHR, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkRenderingAttachmentFlagBitsKHR.html
  ...
  template <> struct FlagTraits<RenderingAttachmentFlagBitsKHR>
  {
    using WrappedType = VkRenderingAttachmentFlagBitsKHR;
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR RenderingAttachmentFlagsKHR allFlags = 
          RenderingAttachmentFlagBitsKHR::eInputAttachmentFeedback
  ...
  template <> struct FlagTraits<ResolveImageFlagBitsKHR>
  {
    using WrappedType = VkResolveImageFlagBitsKHR;
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR ResolveImageFlagsKHR allFlags = 
          ResolveImageFlagBitsKHR::eSkipTransferFunction
        | ResolveImageFlagBitsKHR::eEnableTransferFunction;
  };

  //=== VK_ARM_data_graph_optical_flow ===

  // wrapper class for enum VkDataGraphOpticalFlowImageUsageFlagBitsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowImageUsageFlagBitsARM.html
  ...
  // wrapper using for bitmask VkDataGraphOpticalFlowImageUsageFlagsARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphOpticalFlowImageUsageFlagsARM.html
  using DataGraphOpticalFlowImageUsageFlagsARM = Flags<DataGraphOpticalFlowImageUsageFlagBitsARM>;


  template <> struct FlagTraits<DataGraphOpticalFlowImageUsageFlagBitsARM>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR DataGraphOpticalFlowImageUsageFlagsARM allFlags = 
          DataGraphOpticalFlowImageUsageFlagBitsARM::eUnknown
  ...
  // wrapper class for enum VkDataGraphPipelineNodeConnectionTypeARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkDataGraphPipelineNodeConnectionTypeARM.html
  ...
  template <> struct FlagTraits<UbmSurfaceCreateFlagBitsSEC>
  {
  ...
  // wrapper class for enum VkNeuralAcceleratorStatisticsModeARM, see https://registry.khronos.org/vulkan/specs/latest/man/html/VkNeuralAcceleratorStatisticsModeARM.html
  ...
  //=== VK_AMD_gpa_interface ===
      case ObjectType::eGpaSessionAMD : return DebugReportObjectTypeEXT::eUnknown;
