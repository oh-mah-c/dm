...
static C10_NOINLINE c10::TypedOperatorHandle<get_device::schema> create_get_device_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(get_device::name, get_device::overload_name)
      .typed<get_device::schema>();
}

// aten::get_device(Tensor self) -> int
int64_t get_device::call(const at::Tensor & self) {

    static auto op = create_get_device_typed_handle();
    return op.call(self);
}

// aten::get_device(Tensor self) -> int
int64_t get_device::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
...
static C10_NOINLINE c10::TypedOperatorHandle<is_contiguous::schema> create_is_contiguous_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(is_contiguous::name, is_contiguous::overload_name)
      .typed<is_contiguous::schema>();
}

// aten::is_contiguous(Tensor self) -> bool
bool is_contiguous::call(const at::Tensor & self) {

    static auto op = create_is_contiguous_typed_handle();
    return op.call(self);
}

// aten::is_contiguous(Tensor self) -> bool
bool is_contiguous::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
...
static C10_NOINLINE c10::TypedOperatorHandle<is_contiguous_memory_format::schema> create_is_contiguous_memory_format_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(is_contiguous_memory_format::name, is_contiguous_memory_format::overload_name)
      .typed<is_contiguous_memory_format::schema>();
}

// aten::is_contiguous.memory_format(Tensor self, MemoryFormat memory_format) -> bool
bool is_contiguous_memory_format::call(const at::Tensor & self, at::MemoryFormat memory_format) {

    static auto op = create_is_contiguous_memory_format_typed_handle();
    return op.call(self, memory_format);
}

// aten::is_contiguous.memory_format(Tensor self, MemoryFormat memory_format) -> bool
bool is_contiguous_memory_format::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, at::MemoryFormat memory_format) {
