...
at::Tensor _philox_normal(const at::Tensor & self, const at::Tensor & key, double mean, double std) {
  auto self_clone = clone_arg(self);
  auto output = at::_ops::_philox_normal_::call(const_cast<Tensor&>(self_clone), key, mean, std);
  return self_clone;
}

at::Tensor _philox_uniform(const at::Tensor & self, const at::Tensor & key, double low, double high) {
  auto self_clone = clone_arg(self);
  auto output = at::_ops::_philox_uniform_::call(const_cast<Tensor&>(self_clone), key, low, high);
  return self_clone;
}
...
::std::tuple<at::Tensor &,at::Tensor &> miopen_ctc_loss_out(const at::Tensor & log_probs, const at::Tensor & targets, at::IntArrayRef input_lengths, at::IntArrayRef target_lengths, int64_t blank, bool deterministic, bool zero_infinity, at::Tensor & out0, at::Tensor & out1) {
  auto tmp_output = at::_ops::miopen_ctc_loss::call(log_probs, targets, input_lengths, target_lengths, blank, deterministic, zero_infinity);
    resize_out_helper(out0, std::get<0>(tmp_output));
  copy_arg(out0, std::get<0>(tmp_output));
  resize_out_helper(out1, std::get<1>(tmp_output));
  copy_arg(out1, std::get<1>(tmp_output));
...
at::Tensor & _philox_normal_out(const at::Tensor & self, const at::Tensor & key, double mean, double std, at::Tensor & out) {
  auto tmp_output = at::_ops::_philox_normal::call(self, key, mean, std);
    resize_out_helper(out, tmp_output);
  copy_arg(out, tmp_output);
  return out;
}

at::Tensor & _philox_uniform_out(const at::Tensor & self, const at::Tensor & key, double low, double high, at::Tensor & out) {
  auto tmp_output = at::_ops::_philox_uniform::call(self, key, low, high);
    resize_out_helper(out, tmp_output);
  copy_arg(out, tmp_output);
  return out;
}
...
void _foreach_powsum_Scalar_out(at::TensorList self, const at::Scalar & ord, ::std::optional<at::ScalarType> dtype, at::TensorList out) {
  auto tmp_output = at::_ops::_foreach_powsum_Scalar::call(self, ord, dtype);
    resize_out_helper(out, tmp_output);
  copy_arg(out, tmp_output);
...
void _foreach_clone_out(at::TensorList self, ::std::optional<at::MemoryFormat> memory_format, at::TensorList out) {
  auto tmp_output = at::_ops::_foreach_clone::call(self, memory_format);
    resize_out_helper(out, tmp_output);
  copy_arg(out, tmp_output);
