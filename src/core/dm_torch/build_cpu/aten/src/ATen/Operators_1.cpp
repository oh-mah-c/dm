...
static C10_NOINLINE c10::TypedOperatorHandle<_philox_key_split::schema> create__philox_key_split_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_philox_key_split::name, _philox_key_split::overload_name)
      .typed<_philox_key_split::schema>();
}

// aten::_philox_key_split(Tensor key, int num_splits) -> Tensor
at::Tensor _philox_key_split::call(const at::Tensor & key, int64_t num_splits) {

    static auto op = create__philox_key_split_typed_handle();
    return op.call(key, num_splits);
}

// aten::_philox_key_split(Tensor key, int num_splits) -> Tensor
at::Tensor _philox_key_split::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & key, int64_t num_splits) {

    static auto op = create__philox_key_split_typed_handle();
    return op.redispatch(dispatchKeySet, key, num_splits);
}
...
static C10_NOINLINE c10::TypedOperatorHandle<_foreach_powsum_Scalar::schema> create__foreach_powsum_Scalar_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_foreach_powsum_Scalar::name, _foreach_powsum_Scalar::overload_name)
      .typed<_foreach_powsum_Scalar::schema>();
}

// aten::_foreach_powsum.Scalar(Tensor[] self, Scalar ord=2, ScalarType? dtype=None) -> Tensor[]
::std::vector<at::Tensor> _foreach_powsum_Scalar::call(at::TensorList self, const at::Scalar & ord, ::std::optional<at::ScalarType> dtype) {

    static auto op = create__foreach_powsum_Scalar_typed_handle();
    return op.call(self, ord, dtype);
}

// aten::_foreach_powsum.Scalar(Tensor[] self, Scalar ord=2, ScalarType? dtype=None) -> Tensor[]
::std::vector<at::Tensor> _foreach_powsum_Scalar::redispatch(c10::DispatchKeySet dispatchKeySet, at::TensorList self, const at::Scalar & ord, ::std::optional<at::ScalarType> dtype) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_foreach_clone::schema> create__foreach_clone_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_foreach_clone::name, _foreach_clone::overload_name)
      .typed<_foreach_clone::schema>();
}

// aten::_foreach_clone(Tensor[] self, *, MemoryFormat? memory_format=None) -> Tensor[]
::std::vector<at::Tensor> _foreach_clone::call(at::TensorList self, ::std::optional<at::MemoryFormat> memory_format) {

    static auto op = create__foreach_clone_typed_handle();
    return op.call(self, memory_format);
}

// aten::_foreach_clone(Tensor[] self, *, MemoryFormat? memory_format=None) -> Tensor[]
::std::vector<at::Tensor> _foreach_clone::redispatch(c10::DispatchKeySet dispatchKeySet, at::TensorList self, ::std::optional<at::MemoryFormat> memory_format) {
...
static C10_NOINLINE c10::TypedOperatorHandle<linalg__powsum::schema> create_linalg__powsum_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(linalg__powsum::name, linalg__powsum::overload_name)
      .typed<linalg__powsum::schema>();
}

// aten::linalg__powsum(Tensor self, Scalar ord=2, int[1]? dim=None, bool keepdim=False, *, ScalarType? dtype=None) -> Tensor
at::Tensor linalg__powsum::call(const at::Tensor & self, const at::Scalar & ord, at::OptionalIntArrayRef dim, bool keepdim, ::std::optional<at::ScalarType> dtype) {

    static auto op = create_linalg__powsum_typed_handle();
    return op.call(self, ord, dim, keepdim, dtype);
}

// aten::linalg__powsum(Tensor self, Scalar ord=2, int[1]? dim=None, bool keepdim=False, *, ScalarType? dtype=None) -> Tensor
at::Tensor linalg__powsum::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Scalar & ord, at::OptionalIntArrayRef dim, bool keepdim, ::std::optional<at::ScalarType> dtype) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_scaled_dot_product_flash_attention_quantized::schema> create__scaled_dot_product_flash_attention_quantized_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_scaled_dot_product_flash_attention_quantized::name, _scaled_dot_product_flash_attention_quantized::overload_name)
      .typed<_scaled_dot_product_flash_attention_quantized::schema>();
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,c10::SymInt,c10::SymInt,at::Tensor,at::Tensor,at::Tensor> _scaled_dot_product_flash_attention_quantized::call(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & q_descale, const ::std::optional<at::Tensor> & k_descale, const ::std::optional<at::Tensor> & v_descale, double dropout_p, bool is_causal, bool return_debug_mask, ::std::optional<double> scale) {
    ...
    static auto op = create__scaled_dot_product_flash_attention_quantized_typed_handle();
    return op.call(query, key, value, q_descale, k_descale, v_descale, dropout_p, is_causal, return_debug_mask, scale);
}

// aten::_scaled_dot_product_flash_attention.quantized(Tensor query, Tensor key, Tensor value, Tensor? q_descale, Tensor? k_descale, Tensor? v_descale, float dropout_p=0.0, bool is_causal=False, bool return_debug_mask=False, *, float? scale=None) -> (Tensor output, Tensor logsumexp, Tensor cum_seq_q, Tensor cum_seq_k, SymInt max_q, SymInt max_k, Tensor rng_state, Tensor unused, Tensor debug_attn_mask)
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,c10::SymInt,c10::SymInt,at::Tensor,at::Tensor,at::Tensor> _scaled_dot_product_flash_attention_quantized::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & q_descale, const ::std::optional<at::Tensor> & k_descale, const ::std::optional<at::Tensor> & v_descale, double dropout_p, bool is_causal, bool return_debug_mask, ::std::optional<double> scale) {

    static auto op = create__scaled_dot_product_flash_attention_quantized_typed_handle();
    return op.redispatch(dispatchKeySet, query, key, value, q_descale, k_descale, v_descale, dropout_p, is_causal, return_debug_mask, scale);
}
...
static C10_NOINLINE c10::TypedOperatorHandle<_foreach_powsum_Scalar_out::schema> create__foreach_powsum_Scalar_out_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_foreach_powsum_Scalar_out::name, _foreach_powsum_Scalar_out::overload_name)
      .typed<_foreach_powsum_Scalar_out::schema>();
}

// aten::_foreach_powsum.Scalar_out(Tensor[] self, Scalar ord=2, ScalarType? dtype=None, *, Tensor(a!)[] out) -> ()
void _foreach_powsum_Scalar_out::call(at::TensorList self, const at::Scalar & ord, ::std::optional<at::ScalarType> dtype, at::TensorList out) {

    static auto op = create__foreach_powsum_Scalar_out_typed_handle();
    return op.call(self, ord, dtype, out);
}

// aten::_foreach_powsum.Scalar_out(Tensor[] self, Scalar ord=2, ScalarType? dtype=None, *, Tensor(a!)[] out) -> ()
void _foreach_powsum_Scalar_out::redispatch(c10::DispatchKeySet dispatchKeySet, at::TensorList self, const at::Scalar & ord, ::std::optional<at::ScalarType> dtype, at::TensorList out) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_foreach_clone_out::schema> create__foreach_clone_out_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_foreach_clone_out::name, _foreach_clone_out::overload_name)
      .typed<_foreach_clone_out::schema>();
}

// aten::_foreach_clone.out(Tensor[] self, *, MemoryFormat? memory_format=None, Tensor(a!)[] out) -> ()
void _foreach_clone_out::call(at::TensorList self, ::std::optional<at::MemoryFormat> memory_format, at::TensorList out) {

    static auto op = create__foreach_clone_out_typed_handle();
    return op.call(self, memory_format, out);
}

// aten::_foreach_clone.out(Tensor[] self, *, MemoryFormat? memory_format=None, Tensor(a!)[] out) -> ()
void _foreach_clone_out::redispatch(c10::DispatchKeySet dispatchKeySet, at::TensorList self, ::std::optional<at::MemoryFormat> memory_format, at::TensorList out) {
