...
static PyObject * THPVariable__upsample_lanczos2d_aa(PyObject* self_, PyObject* args, PyObject* kwargs);
...
static PyMethodDef nn_functions[] = {
  ...
  {"_upsample_lanczos2d_aa", castPyCFunctionWithKeywords(THPVariable__upsample_lanczos2d_aa), METH_VARARGS | METH_KEYWORDS, nullptr},
...
static PyObject * THPVariable__upsample_lanczos2d_aa(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_upsample_lanczos2d_aa(Tensor input, SymIntArrayRef? output_size, bool align_corners, ArrayRef<double>? scale_factors)",
    "_upsample_lanczos2d_aa(Tensor input, SymIntArrayRef[2] output_size, bool align_corners, double? scales_h=None, double? scales_w=None, *, Tensor out=None)",
  }, /*traceable=*/true);
  ...
  switch (_r.idx) {
    case 0: {
      ...
      auto dispatch__upsample_lanczos2d_aa = [](const at::Tensor & input, at::OptionalSymIntArrayRef output_size, bool align_corners, ::std::optional<at::ArrayRef<double>> scale_factors) -> at::Tensor {
        pybind11::gil_scoped_release no_gil;
        return at::_upsample_lanczos2d_aa_symint(input, output_size, align_corners, scale_factors);
      };
      return wrap(dispatch__upsample_lanczos2d_aa(_r.tensor(0), _r.symintlistOptional(1), _r.toBool(2), _r.doublelistOptional(3)));
    }
    case 1: {
      if (_r.isNone(5)) {
        ...
        auto dispatch__upsample_lanczos2d_aa = [](const at::Tensor & self, c10::SymIntArrayRef output_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w) -> at::Tensor {
          pybind11::gil_scoped_release no_gil;
          return at::_upsample_lanczos2d_aa_symint(self, output_size, align_corners, scales_h, scales_w);
        };
        return wrap(dispatch__upsample_lanczos2d_aa(_r.tensor(0), _r.symintlist(1), _r.toBool(2), _r.toDoubleOptional(3), _r.toDoubleOptional(4)));
      } else {
        ...
        auto dispatch__upsample_lanczos2d_aa_out = [](at::Tensor out, const at::Tensor & self, c10::SymIntArrayRef output_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w) -> at::Tensor {
          pybind11::gil_scoped_release no_gil;
          return at::_upsample_lanczos2d_aa_symint_out(out, self, output_size, align_corners, scales_h, scales_w);
        };
        return wrap(dispatch__upsample_lanczos2d_aa_out(_r.tensor(5), _r.tensor(0), _r.symintlist(1), _r.toBool(2), _r.toDoubleOptional(3), _r.toDoubleOptional(4)));
      }
    }
  }
  Py_RETURN_NONE;
