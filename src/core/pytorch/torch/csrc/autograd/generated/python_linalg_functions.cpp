...
static PyObject * THPVariable_linalg__powsum(PyObject* self_, PyObject* args, PyObject* kwargs);
...
static PyMethodDef linalg_functions[] = {
  ...
  {"linalg__powsum", castPyCFunctionWithKeywords(THPVariable_linalg__powsum), METH_VARARGS | METH_KEYWORDS, nullptr},
...
static PyObject * THPVariable_linalg__powsum(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "linalg__powsum(Tensor input, Scalar ord=2, IntArrayRef[1]? dim=None, bool keepdim=False, *, ScalarType? dtype=None)",
  }, /*traceable=*/true);
  ...
  auto dispatch_linalg__powsum = [](const at::Tensor & self, const at::Scalar & ord, at::OptionalIntArrayRef dim, bool keepdim, ::std::optional<at::ScalarType> dtype) -> at::Tensor {
    pybind11::gil_scoped_release no_gil;
    return at::linalg__powsum(self, ord, dim, keepdim, dtype);
  };
  return wrap(dispatch_linalg__powsum(_r.tensor(0), _r.scalar(1), _r.intlistOptional(2), _r.toBool(3), _r.scalartypeOptional(4)));
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
