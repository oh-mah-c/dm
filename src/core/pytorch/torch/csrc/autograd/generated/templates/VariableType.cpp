...
${type_derived_method_definitions_AutogradCUDA}

${type_derived_method_definitions_AutogradNestedTensor}
...
${wrapper_registrations_AutogradCUDA}
}

TORCH_LIBRARY_IMPL(aten, AutogradNestedTensor, m) {
${wrapper_registrations_AutogradNestedTensor}
}
