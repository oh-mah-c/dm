...
at::Tensor _test_autograd_multiple_dispatch_fullcoverage_AutogradCUDA(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  c10::intrusive_ptr<TestAutogradMultipleDispatchBackwardAutogradCUDA0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<TestAutogradMultipleDispatchBackwardAutogradCUDA0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _test_autograd_multiple_dispatch_fullcoverage");
  #endif
  if (grad_fn) {
...
at::Tensor _test_autograd_multiple_dispatch_fullcoverage_AutogradNestedTensor(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  c10::intrusive_ptr<TestAutogradMultipleDispatchBackwardAutogradNestedTensor0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<TestAutogradMultipleDispatchBackwardAutogradNestedTensor0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
...
at::Tensor _test_autograd_multiple_dispatch_ntonly_AutogradNestedTensor(c10::DispatchKeySet ks, const at::Tensor & self, bool b) {
  ...
  c10::intrusive_ptr<TestAutogradMultipleDispatchBackwardAutogradNestedTensor1> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<TestAutogradMultipleDispatchBackwardAutogradNestedTensor1>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _test_autograd_multiple_dispatch_ntonly");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor values_AutogradNestedTensor(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  c10::intrusive_ptr<ValuesBackwardAutogradNestedTensor0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ValuesBackwardAutogradNestedTensor0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: values");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor _conj(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  c10::intrusive_ptr<ConjBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ConjBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
  ...
  if (self__storage_saved.has_value() &&
    ...
    TORCH_INTERNAL_ASSERT(self__storage_saved.value().is_alias_of(result.storage()));
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _conj");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor _conj_physical(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<ConjPhysicalBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ConjPhysicalBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _conj_physical");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor _convolution(c10::DispatchKeySet ks, const at::Tensor & input, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias, c10::SymIntArrayRef stride, c10::SymIntArrayRef padding, c10::SymIntArrayRef dilation, bool transposed, c10::SymIntArrayRef output_padding, c10::SymInt groups, bool benchmark, bool deterministic, bool cudnn_enabled, bool allow_tf32) {
  ...
  c10::intrusive_ptr<ConvolutionBackward1> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ConvolutionBackward1>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _convolution");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
::std::tuple<at::Tensor,at::Tensor> _cudnn_ctc_loss(c10::DispatchKeySet ks, const at::Tensor & log_probs, const at::Tensor & targets, at::IntArrayRef input_lengths, at::IntArrayRef target_lengths, int64_t blank, bool deterministic, bool zero_infinity) {
  ...
  c10::intrusive_ptr<CudnnCtcLossBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<CudnnCtcLossBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result0))
    TORCH_INTERNAL_ASSERT(result0.use_count() == expected_fresh_use_count(result0), "function: _cudnn_ctc_loss");
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result1))
    TORCH_INTERNAL_ASSERT(result1.use_count() == expected_fresh_use_count(result1), "function: _cudnn_ctc_loss");
  #endif
  if (grad_fn) {
...
::std::tuple<at::Tensor,at::Tensor> _cudnn_ctc_loss_Tensor(c10::DispatchKeySet ks, const at::Tensor & log_probs, const at::Tensor & targets, const at::Tensor & input_lengths, const at::Tensor & target_lengths, int64_t blank, bool deterministic, bool zero_infinity) {
  ...
  c10::intrusive_ptr<CudnnCtcLossBackward1> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<CudnnCtcLossBackward1>();
    grad_fn->set_next_edges(collect_next_edges( log_probs ));
    grad_fn->zero_infinity = zero_infinity;
  }
  #ifndef NDEBUG
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result0))
    TORCH_INTERNAL_ASSERT(result0.use_count() == expected_fresh_use_count(result0), "function: _cudnn_ctc_loss_Tensor");
  if (result1.has_storage() && !at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result1)) {
    TORCH_INTERNAL_ASSERT(result1.storage().use_count() == 1, "function: _cudnn_ctc_loss_Tensor");
  }
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result1))
    TORCH_INTERNAL_ASSERT(result1.use_count() == expected_fresh_use_count(result1), "function: _cudnn_ctc_loss_Tensor");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result0 ), grad_fn);
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> _cudnn_rnn(c10::DispatchKeySet ks, const at::Tensor & input, at::TensorList weight, int64_t weight_stride0, const ::std::optional<at::Tensor> & weight_buf, const at::Tensor & hx, const ::std::optional<at::Tensor> & cx, int64_t mode, c10::SymInt hidden_size, c10::SymInt proj_size, int64_t num_layers, bool batch_first, double dropout, bool train, bool bidirectional, c10::SymIntArrayRef batch_sizes, const ::std::optional<at::Tensor> & dropout_state) {
  ...
  c10::intrusive_ptr<CudnnRnnBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<CudnnRnnBackward0>();
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> _embedding_bag(c10::DispatchKeySet ks, const at::Tensor & weight, const at::Tensor & indices, const at::Tensor & offsets, bool scale_grad_by_freq, int64_t mode, bool sparse, const ::std::optional<at::Tensor> & per_sample_weights, bool include_last_offset, int64_t padding_idx) {
  ...
  c10::intrusive_ptr<EmbeddingBagBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<EmbeddingBagBackward0>();
...
::std::vector<at::Tensor> _foreach_add_Scalar(c10::DispatchKeySet ks, at::TensorList self, const at::Scalar & scalar) {
  ...
  c10::intrusive_ptr<ForeachAddBackward1Scalar> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachAddBackward1Scalar>();
    grad_fn->set_next_edges(collect_next_edges( self ));
...
::std::vector<at::Tensor> _foreach_add_List(c10::DispatchKeySet ks, at::TensorList self, at::TensorList other, const at::Scalar & alpha) {
  ...
  c10::intrusive_ptr<ForeachAddBackward0List> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachAddBackward0List>();
...
::std::vector<at::Tensor> _foreach_add_ScalarList(c10::DispatchKeySet ks, at::TensorList self, at::ArrayRef<at::Scalar> scalars) {
  ...
  c10::intrusive_ptr<ForeachAddBackward1ScalarList> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachAddBackward1ScalarList>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_ = make_saved_variable_list(self, false);
    grad_fn->self_size_ = self.size();
  }
...
::std::vector<at::Tensor> _foreach_add_Tensor(c10::DispatchKeySet ks, at::TensorList self, const at::Tensor & other, const at::Scalar & alpha) {
  ...
  c10::intrusive_ptr<ForeachAddBackward0Tensor> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachAddBackward0Tensor>();
    grad_fn->set_next_edges(collect_next_edges( self, other ));
    grad_fn->alpha = alpha;
...
::std::vector<at::Tensor> _foreach_clamp_min_Scalar(c10::DispatchKeySet ks, at::TensorList self, const at::Scalar & scalar) {
  ...
  c10::intrusive_ptr<ForeachClampMinBackward0Scalar> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachClampMinBackward0Scalar>();
    grad_fn->set_next_edges(collect_next_edges( self ));
...
::std::vector<at::Tensor> _foreach_clamp_min_List(c10::DispatchKeySet ks, at::TensorList self, at::TensorList other) {
  ...
  c10::intrusive_ptr<ForeachClampMinBackward1List> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachClampMinBackward1List>();
    grad_fn->set_next_edges(collect_next_edges( self, other ));
    grad_fn->other_ = make_saved_variable_list(other, false);
    grad_fn->self_ = make_saved_variable_list(self, false);
    grad_fn->self_size_ = self.size();
...
::std::vector<at::Tensor> _foreach_clamp_min_ScalarList(c10::DispatchKeySet ks, at::TensorList self, at::ArrayRef<at::Scalar> scalars) {
  ...
  c10::intrusive_ptr<ForeachClampMinBackward0ScalarList> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachClampMinBackward0ScalarList>();
    grad_fn->set_next_edges(collect_next_edges( self ));
...
void _foreach_clamp_min__Scalar(c10::DispatchKeySet ks, at::TensorList self, const at::Scalar & scalar) {
  ...
  std::vector<c10::intrusive_ptr<ClampMinBackward0>> grad_fns;
  if (_any_requires_grad) {
    for (const auto& i : c10::irange( self.size() )) {
      const auto ith_requires_grad = compute_requires_grad(self[i]);
      check_inplace(self[i], ith_requires_grad);
      grad_fns.push_back([&]() -> c10::intrusive_ptr<ClampMinBackward0> {
          if (!ith_requires_grad) {
              return nullptr;
          } else {
              auto grad_fn = c10::make_intrusive<ClampMinBackward0>();
...
void _foreach_clamp_min__List(c10::DispatchKeySet ks, at::TensorList self, at::TensorList other) {
  ...
  std::vector<c10::intrusive_ptr<ClampMinBackward1>> grad_fns;
  if (_any_requires_grad) {
    for (const auto& i : c10::irange( self.size() )) {
      const auto ith_requires_grad = compute_requires_grad(self[i], other[i]);
      check_inplace(self[i], ith_requires_grad);
      grad_fns.push_back([&]() -> c10::intrusive_ptr<ClampMinBackward1> {
          if (!ith_requires_grad) {
              return nullptr;
          } else {
              auto grad_fn = c10::make_intrusive<ClampMinBackward1>();
...
::std::vector<at::Tensor> _foreach_cosh(c10::DispatchKeySet ks, at::TensorList self) {
  ...
  c10::intrusive_ptr<ForeachCoshBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachCoshBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_ = make_saved_variable_list(self, false);
    grad_fn->self_size_ = self.size();
  }
...
::std::vector<at::Tensor> _foreach_erfc(c10::DispatchKeySet ks, at::TensorList self) {
  ...
  c10::intrusive_ptr<ForeachErfcBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachErfcBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_ = make_saved_variable_list(self, false);
    grad_fn->self_size_ = self.size();
  }
...
void _foreach_expm1_(c10::DispatchKeySet ks, at::TensorList self) {
  ...
  std::vector<::std::optional<at::Tensor>> original_selfs(self.size());
  std::vector<c10::intrusive_ptr<Expm1Backward0>> grad_fns;
  if (_any_requires_grad) {
    for (const auto& i : c10::irange( self.size() )) {
      const auto ith_requires_grad = compute_requires_grad(self[i]);
      check_inplace(self[i], ith_requires_grad);
      grad_fns.push_back([&]() -> c10::intrusive_ptr<Expm1Backward0> {
          if (!ith_requires_grad) {
              return nullptr;
          } else {
              auto grad_fn = c10::make_intrusive<Expm1Backward0>();
              grad_fn->set_next_edges(collect_next_edges( self[i] ));
              return grad_fn;
          }
      }());
...
::std::vector<at::Tensor> _foreach_lerp_List(c10::DispatchKeySet ks, at::TensorList self, at::TensorList tensors1, at::TensorList weights) {
  ...
  c10::intrusive_ptr<ForeachLerpBackward1List> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachLerpBackward1List>();
  ...
  for (const auto& i : c10::irange(result_new_fw_grad_opts.size())) {
    if (_any_has_forward_grad_result[i]) {
        ...
        auto tensors1_t = (tensors1_t_raw.defined() || !tensors1_tensor.defined())
          ? tensors1_t_raw : at::_efficientzerotensor_symint(tensors1_tensor.sym_sizes(), tensors1_tensor.options());
        update_wrapped_number(tensors1_tensor, tensors1_t);
        ...
        auto weights_t = (weights_t_raw.defined() || !weights_tensor.defined())
          ? weights_t_raw : at::_efficientzerotensor_symint(weights_tensor.sym_sizes(), weights_tensor.options());
        update_wrapped_number(weights_tensor, weights_t);
...
::std::vector<at::Tensor> _foreach_lerp_Scalar(c10::DispatchKeySet ks, at::TensorList self, at::TensorList tensors1, const at::Scalar & weight) {
  ...
  c10::intrusive_ptr<ForeachLerpBackward0Scalar> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachLerpBackward0Scalar>();
...
::std::vector<at::Tensor> _foreach_lerp_ScalarList(c10::DispatchKeySet ks, at::TensorList self, at::TensorList tensors1, at::ArrayRef<at::Scalar> weight) {
  ...
  c10::intrusive_ptr<ForeachLerpBackward0ScalarList> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachLerpBackward0ScalarList>();
    grad_fn->set_next_edges(collect_next_edges( self, tensors1 ));
    grad_fn->weight = weight.vec();
    grad_fn->self_size_ = self.size();
    grad_fn->tensors1_size_ = tensors1.size();
  }
  #ifndef NDEBUG
  ...
  for (const auto& i : c10::irange(result_new_fw_grad_opts.size())) {
    if (_any_has_forward_grad_result[i]) {
        ...
        auto tensors1_t = (tensors1_t_raw.defined() || !tensors1_tensor.defined())
          ? tensors1_t_raw : at::_efficientzerotensor_symint(tensors1_tensor.sym_sizes(), tensors1_tensor.options());
        update_wrapped_number(tensors1_tensor, tensors1_t);
        result_new_fw_grad_opts[i] = at::lerp(self_t, tensors1_t, weight[i]);
    }
  }
  for (const auto& i : c10::irange(result_new_fw_grad_opts.size())) {
    auto& result_new_fw_grad_opt = result_new_fw_grad_opts[i];
...
::std::vector<at::Tensor> _foreach_lgamma(c10::DispatchKeySet ks, at::TensorList self) {
  ...
  c10::intrusive_ptr<ForeachLgammaBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachLgammaBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_ = make_saved_variable_list(self, false);
    grad_fn->self_size_ = self.size();
  }
...
void _foreach_log_(c10::DispatchKeySet ks, at::TensorList self) {
  ...
  std::vector<c10::intrusive_ptr<LogBackward0>> grad_fns;
  if (_any_requires_grad) {
    for (const auto& i : c10::irange( self.size() )) {
      const auto ith_requires_grad = compute_requires_grad(self[i]);
      check_inplace(self[i], ith_requires_grad);
      grad_fns.push_back([&]() -> c10::intrusive_ptr<LogBackward0> {
          if (!ith_requires_grad) {
              return nullptr;
          } else {
              auto grad_fn = c10::make_intrusive<LogBackward0>();
              grad_fn->set_next_edges(collect_next_edges( self[i] ));
              return grad_fn;
          }
      }());
...
void _foreach_max_out_out(c10::DispatchKeySet ks, at::TensorList self, at::TensorList out) {
  ...
  {
    at::AutoDispatchBelowAutograd guard;
    at::redispatch::_foreach_max_outf(ks & c10::after_autograd_keyset, self_, out_);
  }
  #ifndef NDEBUG
  for (size_t i=0; i<self_.size() && !at::impl::dispatch_mode_enabled(); i++) {
    if (self__storage_saved[i].has_value() && !at::impl::tensorlist_has_dispatch(self_))
  ...
  #endif
  TORCH_CHECK_NOT_IMPLEMENTED(!((isFwGradDefinedTensorList(self) || isFwGradDefinedTensorList(out))), "Trying to use forward AD with _foreach_max_out that does not support it because it is an out= function");
}
    ...
    for (const auto& i : c10::irange( self.size() )) {
      ...
      grad_fns.push_back([&]() -> c10::intrusive_ptr<NotImplemented> {
          if (!ith_requires_grad) {
              ...
              auto grad_fn = c10::make_intrusive<NotImplemented>("_foreach_minimum_");
              grad_fn->set_next_edges(collect_next_edges( self[i] ));
              return grad_fn;
          }
      }());
...
void _foreach_minimum__List(c10::DispatchKeySet ks, at::TensorList self, at::TensorList other) {
  ...
  std::vector<c10::intrusive_ptr<MinimumBackward0>> grad_fns;
  if (_any_requires_grad) {
    for (const auto& i : c10::irange( self.size() )) {
      const auto ith_requires_grad = compute_requires_grad(self[i], other[i]);
      check_inplace(self[i], ith_requires_grad);
      grad_fns.push_back([&]() -> c10::intrusive_ptr<MinimumBackward0> {
          if (!ith_requires_grad) {
              return nullptr;
          } else {
              auto grad_fn = c10::make_intrusive<MinimumBackward0>();
              grad_fn->set_next_edges(collect_next_edges( self[i], other[i] ));
              return grad_fn;
          }
      }());
...
::std::vector<at::Tensor> _foreach_round(c10::DispatchKeySet ks, at::TensorList self) {
  ...
  c10::intrusive_ptr<ForeachRoundBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ForeachRoundBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_size_ = self.size();
  }
  #ifndef NDEBUG
...
void _fused_adagrad_(c10::DispatchKeySet ks, at::TensorList self, at::TensorList grads, at::TensorList state_sums, at::TensorList state_steps, double lr, double lr_decay, double weight_decay, double eps, bool maximize, const ::std::optional<at::Tensor> & grad_scale, const ::std::optional<at::Tensor> & found_inf) {
  ...
  {
    at::AutoDispatchBelowAutograd guard;
    at::redispatch::_fused_adagrad_(ks & c10::after_autograd_keyset, self_, grads_, state_sums_, state_steps_, lr, lr_decay, weight_decay, eps, maximize, grad_scale, found_inf);
  }
  #ifndef NDEBUG
  for (size_t i=0; i<self_.size() && !at::impl::dispatch_mode_enabled(); i++) {
    if (self__storage_saved[i].has_value() && !at::impl::tensorlist_has_dispatch(self_))
...
void _fused_adagrad__tensor_lr(c10::DispatchKeySet ks, at::TensorList self, at::TensorList grads, at::TensorList state_sums, at::TensorList state_steps, const at::Tensor & lr, double lr_decay, double weight_decay, double eps, bool maximize, const ::std::optional<at::Tensor> & grad_scale, const ::std::optional<at::Tensor> & found_inf) {
  ...
  {
    at::AutoDispatchBelowAutograd guard;
    at::redispatch::_fused_adagrad_(ks & c10::after_autograd_keyset, self_, grads_, state_sums_, state_steps_, lr_, lr_decay, weight_decay, eps, maximize, grad_scale, found_inf);
  }
  #ifndef NDEBUG
  for (size_t i=0; i<self_.size() && !at::impl::dispatch_mode_enabled(); i++) {
    if (self__storage_saved[i].has_value() && !at::impl::tensorlist_has_dispatch(self_))
...
::std::tuple<at::Tensor,at::Tensor> _fused_dropout(c10::DispatchKeySet ks, const at::Tensor & self, double p, ::std::optional<at::Generator> generator) {
  ...
  c10::intrusive_ptr<FusedDropoutBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<FusedDropoutBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->p = p;
  }
  #ifndef NDEBUG
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result0))
    TORCH_INTERNAL_ASSERT(result0.use_count() == expected_fresh_use_count(result0), "function: _fused_dropout");
  if (result1.has_storage() && !at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result1)) {
    TORCH_INTERNAL_ASSERT(result1.storage().use_count() == 1, "function: _fused_dropout");
  }
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result1))
    TORCH_INTERNAL_ASSERT(result1.use_count() == expected_fresh_use_count(result1), "function: _fused_dropout");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result0 ), grad_fn);
  }
...
::std::tuple<at::Tensor,at::Tensor> _fused_moving_avg_obs_fq_helper(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & observer_on, const at::Tensor & fake_quant_on, at::Tensor & running_min, at::Tensor & running_max, at::Tensor & scale, at::Tensor & zero_point, double averaging_const, int64_t quant_min, int64_t quant_max, int64_t ch_axis, bool per_row_fake_quant, bool symmetric_quant) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(output))
    TORCH_INTERNAL_ASSERT(output.use_count() == expected_fresh_use_count(output), "function: _fused_moving_avg_obs_fq_helper");
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(mask))
    TORCH_INTERNAL_ASSERT(mask.use_count() == expected_fresh_use_count(mask), "function: _fused_moving_avg_obs_fq_helper");
  #endif
  if (grad_fn) {
...
void _fused_sgd_out_out(c10::DispatchKeySet ks, at::TensorList self, at::TensorList grads, at::TensorList momentum_buffer_list, double weight_decay, double momentum, double lr, double dampening, bool nesterov, bool maximize, bool is_first_step, const ::std::optional<at::Tensor> & grad_scale, const ::std::optional<at::Tensor> & found_inf, at::TensorList out) {
  ...
  {
    at::AutoDispatchBelowAutograd guard;
    at::redispatch::_fused_sgd_outf(ks & c10::after_autograd_keyset, self_, grads_, momentum_buffer_list_, weight_decay, momentum, lr, dampening, nesterov, maximize, is_first_step, grad_scale, found_inf, out_);
  }
  #ifndef NDEBUG
  for (size_t i=0; i<self_.size() && !at::impl::dispatch_mode_enabled(); i++) {
    if (self__storage_saved[i].has_value() && !at::impl::tensorlist_has_dispatch(self_))
  ...
  #endif
  TORCH_CHECK_NOT_IMPLEMENTED(!((isFwGradDefinedTensorList(self) || isFwGradDefinedTensorList(grads) || isFwGradDefinedTensorList(momentum_buffer_list) || isFwGradDefined(grad_scale) || isFwGradDefined(found_inf) || isFwGradDefinedTensorList(out))), "Trying to use forward AD with _fused_sgd_out that does not support it because it is an out= function");
}
void _fused_sgd_out_tensor_lr_out(c10::DispatchKeySet ks, at::TensorList self, at::TensorList grads, at::TensorList momentum_buffer_list, double weight_decay, double momentum, const at::Tensor & lr, double dampening, bool nesterov, bool maximize, bool is_first_step, const ::std::optional<at::Tensor> & grad_scale, const ::std::optional<at::Tensor> & found_inf, at::TensorList out) {
  ...
  {
    at::AutoDispatchBelowAutograd guard;
    at::redispatch::_fused_sgd_outf(ks & c10::after_autograd_keyset, self_, grads_, momentum_buffer_list_, weight_decay, momentum, lr_, dampening, nesterov, maximize, is_first_step, grad_scale, found_inf, out_);
  }
  #ifndef NDEBUG
  for (size_t i=0; i<self_.size() && !at::impl::dispatch_mode_enabled(); i++) {
    if (self__storage_saved[i].has_value() && !at::impl::tensorlist_has_dispatch(self_))
  ...
  #endif
  TORCH_CHECK_NOT_IMPLEMENTED(!((isFwGradDefinedTensorList(self) || isFwGradDefinedTensorList(grads) || isFwGradDefinedTensorList(momentum_buffer_list) || isFwGradDefined(lr) || isFwGradDefined(grad_scale) || isFwGradDefined(found_inf) || isFwGradDefinedTensorList(out))), "Trying to use forward AD with _fused_sgd_out that does not support it because it is an out= function");
}
at::Tensor _index_put_impl(c10::DispatchKeySet ks, const at::Tensor & self, const c10::List<::std::optional<at::Tensor>> & indices, const at::Tensor & values, bool accumulate, bool unsafe) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _index_put_impl");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
::std::tuple<at::Tensor,at::Tensor> _linalg_eigh(c10::DispatchKeySet ks, const at::Tensor & A, c10::string_view UPLO, bool compute_v) {
  ...
  c10::intrusive_ptr<LinalgEighBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<LinalgEighBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(eigenvalues))
    TORCH_INTERNAL_ASSERT(eigenvalues.use_count() == expected_fresh_use_count(eigenvalues), "function: _linalg_eigh");
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(eigenvectors))
    TORCH_INTERNAL_ASSERT(eigenvectors.use_count() == expected_fresh_use_count(eigenvectors), "function: _linalg_eigh");
  #endif
  if (grad_fn) {
...
at::Tensor _neg_view_copy(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<NegViewBackward0_copy> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<NegViewBackward0_copy>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _neg_view_copy");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
::std::tuple<at::Tensor,at::Tensor> _prelu_kernel_backward(c10::DispatchKeySet ks, const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & weight) {
  ...
  c10::intrusive_ptr<PreluKernelBackwardBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<PreluKernelBackwardBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result0))
    TORCH_INTERNAL_ASSERT(result0.use_count() == expected_fresh_use_count(result0), "function: _prelu_kernel_backward");
  if (result1.has_storage() && !at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result1)) {
    TORCH_INTERNAL_ASSERT(result1.storage().use_count() == 1, "function: _prelu_kernel_backward");
  }
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result1))
    TORCH_INTERNAL_ASSERT(result1.use_count() == expected_fresh_use_count(result1), "function: _prelu_kernel_backward");
  #endif
  if (grad_fn) {
...
at::Tensor _sparse_addmm(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & mat1, const at::Tensor & mat2, const at::Scalar & beta, const at::Scalar & alpha) {
  ...
  c10::intrusive_ptr<SparseAddmmBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<SparseAddmmBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _sparse_addmm");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor _sparse_sum_dim(c10::DispatchKeySet ks, const at::Tensor & self, at::IntArrayRef dim) {
  ...
  c10::intrusive_ptr<SparseSumBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<SparseSumBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->dim = dim.vec();
    grad_fn->self_ = SavedVariable(self, false);
  }
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _sparse_sum_dim");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor _test_autograd_multiple_dispatch_fullcoverage(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<TestAutogradMultipleDispatchBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<TestAutogradMultipleDispatchBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_sym_sizes = self.sym_sizes().vec();
  }
  #ifndef NDEBUG
...
at::Tensor _to_copy(c10::DispatchKeySet ks, const at::Tensor & self, ::std::optional<at::ScalarType> dtype, ::std::optional<at::Layout> layout, ::std::optional<at::Device> device, ::std::optional<bool> pin_memory, bool non_blocking, ::std::optional<at::MemoryFormat> memory_format) {
  ...
  c10::intrusive_ptr<ToCopyBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ToCopyBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_options = self.options();
  }
  #ifndef NDEBUG
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _to_copy");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor _upsample_bicubic2d_aa(c10::DispatchKeySet ks, const at::Tensor & self, c10::SymIntArrayRef output_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<UpsampleBicubic2DAaBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<UpsampleBicubic2DAaBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _upsample_bicubic2d_aa");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor _upsample_bilinear2d_aa_backward(c10::DispatchKeySet ks, const at::Tensor & grad_output, c10::SymIntArrayRef output_size, c10::SymIntArrayRef input_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(grad_output));
  c10::intrusive_ptr<UpsampleBilinear2DAaBackwardBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<UpsampleBilinear2DAaBackwardBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: _upsample_bilinear2d_aa_backward");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor addcmul(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & tensor1, const at::Tensor & tensor2, const at::Scalar & value) {
  ...
  c10::intrusive_ptr<AddcmulBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<AddcmulBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: addcmul");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor addmm(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & mat1, const at::Tensor & mat2, const at::Scalar & beta, const at::Scalar & alpha) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: addmm");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
::std::tuple<at::Tensor,at::Tensor> aminmax(c10::DispatchKeySet ks, const at::Tensor & self, ::std::optional<int64_t> dim, bool keepdim) {
  ...
  c10::intrusive_ptr<AminmaxBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<AminmaxBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->dim = dim;
  ...
  auto _tmp = ([&]() {
    at::AutoDispatchBelowADInplaceOrView guard;
    return at::redispatch::aminmax(ks & c10::after_autograd_keyset, self_, dim, keepdim);
  })();
  auto [min, max] = std::move(_tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value() &&
      !at::impl::dispatch_mode_enabled() &&
      !at::impl::tensor_has_dispatch(self_) &&
  ...
  if (self__impl_saved && !at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(self_))
    TORCH_INTERNAL_ASSERT(self__impl_saved == self_.getIntrusivePtr());
  if (min.has_storage() && !at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(min)) {
    TORCH_INTERNAL_ASSERT(min.storage().use_count() == 1, "function: aminmax");
  }
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(min))
    TORCH_INTERNAL_ASSERT(min.use_count() == expected_fresh_use_count(min), "function: aminmax");
  if (max.has_storage() && !at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(max)) {
    TORCH_INTERNAL_ASSERT(max.storage().use_count() == 1, "function: aminmax");
  }
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(max))
    TORCH_INTERNAL_ASSERT(max.use_count() == expected_fresh_use_count(max), "function: aminmax");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( min, max ), grad_fn);
  }
  throw_error_for_complex_autograd(min, "aminmax");
  throw_error_for_complex_autograd(max, "aminmax");
  ::std::optional<at::Tensor> max_new_fw_grad_opt = ::std::nullopt;
  if (_any_has_forward_grad_max && (max.defined())) {
      auto self_t_raw = toNonOptFwGrad(self);
      auto self_tensor = toNonOptTensor(self);
      auto self_t = (self_t_raw.defined() || !self_tensor.defined())
        ? self_t_raw : at::_efficientzerotensor_symint(self_tensor.sym_sizes(), self_tensor.options());
      update_wrapped_number(self_tensor, self_t);
      auto self_p = toNonOptPrimal(self);
      max_new_fw_grad_opt = aminmax_jvp(self_p, self_t, max, dim, keepdim);
  }
  ::std::optional<at::Tensor> min_new_fw_grad_opt = ::std::nullopt;
  if (_any_has_forward_grad_min && (min.defined())) {
      auto self_t_raw = toNonOptFwGrad(self);
      auto self_tensor = toNonOptTensor(self);
      auto self_t = (self_t_raw.defined() || !self_tensor.defined())
        ? self_t_raw : at::_efficientzerotensor_symint(self_tensor.sym_sizes(), self_tensor.options());
      update_wrapped_number(self_tensor, self_t);
      auto self_p = toNonOptPrimal(self);
      min_new_fw_grad_opt = aminmax_jvp(self_p, self_t, min, dim, keepdim);
  }
  if (max_new_fw_grad_opt.has_value() && max_new_fw_grad_opt.value().defined() && max.defined()) {
    // The hardcoded 0 here will need to be updated once we support multiple levels.
    max._set_fw_grad(max_new_fw_grad_opt.value(), /* level */ 0, /* is_inplace_op */ false);
  }

  if (min_new_fw_grad_opt.has_value() && min_new_fw_grad_opt.value().defined() && min.defined()) {
    // The hardcoded 0 here will need to be updated once we support multiple levels.
    min._set_fw_grad(min_new_fw_grad_opt.value(), /* level */ 0, /* is_inplace_op */ false);
  }
  if (grad_fn) {
    grad_fn->max_ = SavedVariable(max, true);
    grad_fn->min_ = SavedVariable(min, true);
  }
...
at::Tensor argmax(c10::DispatchKeySet ks, const at::Tensor & self, ::std::optional<int64_t> dim, bool keepdim) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: argmax");
  #endif
  return result;
}
at::Tensor as_strided(c10::DispatchKeySet ks, const at::Tensor & self, c10::SymIntArrayRef size, c10::SymIntArrayRef stride, ::std::optional<c10::SymInt> storage_offset) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<AsStridedBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<AsStridedBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  ...
  if (self__storage_saved.has_value() &&
    ...
    TORCH_INTERNAL_ASSERT(self__storage_saved.value().is_alias_of(result.storage()));
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: as_strided");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor as_strided_scatter(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & src, c10::SymIntArrayRef size, c10::SymIntArrayRef stride, ::std::optional<c10::SymInt> storage_offset) {
  ...
  c10::intrusive_ptr<AsStridedScatterBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<AsStridedScatterBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: as_strided_scatter");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor & atanh_(c10::DispatchKeySet ks, at::Tensor & self) {
  ...
  check_inplace(self, _any_requires_grad);
  ::std::optional<at::Tensor> original_self;
  c10::intrusive_ptr<AtanhBackward1> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<AtanhBackward1>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
...
at::Tensor cudnn_convolution_transpose(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & weight, c10::SymIntArrayRef padding, c10::SymIntArrayRef output_padding, c10::SymIntArrayRef stride, c10::SymIntArrayRef dilation, c10::SymInt groups, bool benchmark, bool deterministic, bool allow_tf32) {
  ...
  c10::intrusive_ptr<CudnnConvolutionTransposeBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<CudnnConvolutionTransposeBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: cudnn_convolution_transpose");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor expm1(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: expm1");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor exponential(c10::DispatchKeySet ks, const at::Tensor & self, double lambd, ::std::optional<at::Generator> generator) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<ExponentialBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ExponentialBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: exponential");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor fill_Scalar(c10::DispatchKeySet ks, const at::Tensor & self, const at::Scalar & value) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<FillBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<FillBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: fill_Scalar");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor fill_Tensor(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & value) {
  ...
  c10::intrusive_ptr<FillBackward1> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<FillBackward1>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: fill_Tensor");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor fractional_max_pool3d_backward(c10::DispatchKeySet ks, const at::Tensor & grad_output, const at::Tensor & self, at::IntArrayRef kernel_size, at::IntArrayRef output_size, const at::Tensor & indices) {
  ...
  c10::intrusive_ptr<FractionalMaxPool3DBackwardBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<FractionalMaxPool3DBackwardBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: fractional_max_pool3d_backward");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor geometric(c10::DispatchKeySet ks, const at::Tensor & self, double p, ::std::optional<at::Generator> generator) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<GeometricBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<GeometricBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: geometric");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor index_select(c10::DispatchKeySet ks, const at::Tensor & self, int64_t dim, const at::Tensor & index) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<IndexSelectBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<IndexSelectBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->dim = dim;
    grad_fn->index_ = SavedVariable(index, false);
    grad_fn->self_sym_sizes = self.sym_sizes().vec();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: index_select");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor lift_fresh(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<LiftFreshBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<LiftFreshBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
...
::std::tuple<at::Tensor &,at::Tensor &> linalg_inv_ex_out_inverse(c10::DispatchKeySet ks, const at::Tensor & A, bool check_errors, at::Tensor & inverse, at::Tensor & info) {
  ...
  c10::intrusive_ptr<TensorImpl> A__impl_saved;
  if (A_.defined()) A__impl_saved = A_.getIntrusivePtr();
  auto inverse__storage_saved =
    inverse_.has_storage() ? ::std::optional<Storage>(inverse_.storage()) : ::std::nullopt;
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> linalg_lstsq(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & b, ::std::optional<double> rcond, ::std::optional<c10::string_view> driver) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_residuals = (isFwGradDefined(self) || isFwGradDefined(b));
  [[maybe_unused]] auto _any_has_forward_grad_solution = (isFwGradDefined(self) || isFwGradDefined(b));
  c10::intrusive_ptr<LinalgLstsqBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<LinalgLstsqBackward0>();
  ...
  auto [solution, residuals, rank, singular_values] = std::move(_tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value() &&
      !at::impl::dispatch_mode_enabled() &&
      !at::impl::tensor_has_dispatch(self_) &&
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(solution))
    TORCH_INTERNAL_ASSERT(solution.use_count() == expected_fresh_use_count(solution), "function: linalg_lstsq");
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(residuals))
    TORCH_INTERNAL_ASSERT(residuals.use_count() == expected_fresh_use_count(residuals), "function: linalg_lstsq");
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(rank))
    TORCH_INTERNAL_ASSERT(rank.use_count() == expected_fresh_use_count(rank), "function: linalg_lstsq");
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(singular_values))
    TORCH_INTERNAL_ASSERT(singular_values.use_count() == expected_fresh_use_count(singular_values), "function: linalg_lstsq");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( solution, residuals ), grad_fn);
  }
  ::std::optional<at::Tensor> residuals_new_fw_grad_opt = ::std::nullopt;
  if (_any_has_forward_grad_residuals && (residuals.defined())) {
      auto self_t_raw = toNonOptFwGrad(self);
      auto self_tensor = toNonOptTensor(self);
      auto self_t = (self_t_raw.defined() || !self_tensor.defined())
        ? self_t_raw : at::_efficientzerotensor_symint(self_tensor.sym_sizes(), self_tensor.options());
      ...
      residuals_new_fw_grad_opt = linalg_lstsq_residuals_jvp(self_p, b_p, self_t, b_t, solution, residuals);
  }
  ...
  if (_any_has_forward_grad_solution && (solution.defined())) {
      ...
      update_wrapped_number(b_tensor, b_t);
      auto b_p = toNonOptPrimal(b);
      solution_new_fw_grad_opt = linalg_lstsq_solution_jvp(self_p, b_p, self_t, b_t);
  }
  if (residuals_new_fw_grad_opt.has_value() && residuals_new_fw_grad_opt.value().defined() && residuals.defined()) {
    // The hardcoded 0 here will need to be updated once we support multiple levels.
    residuals._set_fw_grad(residuals_new_fw_grad_opt.value(), /* level */ 0, /* is_inplace_op */ false);
  }
...
::std::tuple<at::Tensor &,at::Tensor &,at::Tensor &,at::Tensor &> linalg_lstsq_out_out(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & b, ::std::optional<double> rcond, ::std::optional<c10::string_view> driver, at::Tensor & solution, at::Tensor & residuals, at::Tensor & rank, at::Tensor & singular_values) {
  ...
  c10::intrusive_ptr<TensorImpl> b__impl_saved;
  if (b_.defined()) b__impl_saved = b_.getIntrusivePtr();
  auto solution__storage_saved =
    solution_.has_storage() ? ::std::optional<Storage>(solution_.storage()) : ::std::nullopt;
  c10::intrusive_ptr<TensorImpl> solution__impl_saved;
  if (solution_.defined()) solution__impl_saved = solution_.getIntrusivePtr();
  auto residuals__storage_saved =
    residuals_.has_storage() ? ::std::optional<Storage>(residuals_.storage()) : ::std::nullopt;
  c10::intrusive_ptr<TensorImpl> residuals__impl_saved;
  if (residuals_.defined()) residuals__impl_saved = residuals_.getIntrusivePtr();
  auto rank__storage_saved =
    rank_.has_storage() ? ::std::optional<Storage>(rank_.storage()) : ::std::nullopt;
  c10::intrusive_ptr<TensorImpl> rank__impl_saved;
  if (rank_.defined()) rank__impl_saved = rank_.getIntrusivePtr();
  auto singular_values__storage_saved =
    singular_values_.has_storage() ? ::std::optional<Storage>(singular_values_.storage()) : ::std::nullopt;
...
at::Tensor linalg_matrix_exp(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<LinalgMatrixExpBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<LinalgMatrixExpBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_ = SavedVariable(self, false);
  }
  #ifndef NDEBUG
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: linalg_matrix_exp");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor log10(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<Log10Backward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<Log10Backward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_ = SavedVariable(self, false);
  }
  #ifndef NDEBUG
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: log10");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor log1p(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: log1p");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor logaddexp2(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & other) {
  ...
  c10::intrusive_ptr<Logaddexp2Backward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<Logaddexp2Backward0>();
    grad_fn->set_next_edges(collect_next_edges( self, other ));
    grad_fn->other_ = SavedVariable(other, false);
    grad_fn->self_ = SavedVariable(self, false);
  }
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: logaddexp2");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor logsumexp(c10::DispatchKeySet ks, const at::Tensor & self, at::IntArrayRef dim, bool keepdim) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<LogsumexpBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<LogsumexpBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->dim = dim.vec();
    grad_fn->keepdim = keepdim;
    grad_fn->self_ = SavedVariable(self, false);
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: logsumexp");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> lu_unpack(c10::DispatchKeySet ks, const at::Tensor & LU_data, const at::Tensor & LU_pivots, bool unpack_data, bool unpack_pivots) {
  ...
  c10::intrusive_ptr<LuUnpackBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<LuUnpackBackward0>();
  ...
  if (_any_has_forward_grad_L && (L.defined())) {
      ...
      auto LU_data_t = (LU_data_t_raw.defined() || !LU_data_tensor.defined())
        ? LU_data_t_raw : at::_efficientzerotensor_symint(LU_data_tensor.sym_sizes(), LU_data_tensor.options());
      update_wrapped_number(LU_data_tensor, LU_data_t);
      L_new_fw_grad_opt = LU_data_t.sym_size(-2) >= LU_data_t.sym_size(-1) ? LU_data_t.tril_symint(-1) : LU_data_t.narrow_symint(-1, 0, LU_data_t.sym_size(-2)).tril_symint(-1);
  }
  ...
  if (_any_has_forward_grad_U && (U.defined())) {
      ...
      auto LU_data_t = (LU_data_t_raw.defined() || !LU_data_tensor.defined())
        ? LU_data_t_raw : at::_efficientzerotensor_symint(LU_data_tensor.sym_sizes(), LU_data_tensor.options());
      update_wrapped_number(LU_data_tensor, LU_data_t);
      U_new_fw_grad_opt = LU_data_t.sym_size(-1) >= LU_data_t.sym_size(-2) ? LU_data_t.triu_symint() : LU_data_t.narrow_symint(-2, 0, LU_data_t.sym_size(-1)).triu_symint();
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> miopen_batch_norm_backward(c10::DispatchKeySet ks, const at::Tensor & input, const at::Tensor & grad_output, const at::Tensor & weight, const ::std::optional<at::Tensor> & running_mean, const ::std::optional<at::Tensor> & running_var, const ::std::optional<at::Tensor> & save_mean, const ::std::optional<at::Tensor> & save_var, double epsilon) {
  ...
  c10::intrusive_ptr<MiopenBatchNormBackwardBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<MiopenBatchNormBackwardBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result0))
    TORCH_INTERNAL_ASSERT(result0.use_count() == expected_fresh_use_count(result0), "function: miopen_batch_norm_backward");
  if (result1.has_storage() && !at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result1)) {
    TORCH_INTERNAL_ASSERT(result1.storage().use_count() == 1, "function: miopen_batch_norm_backward");
  }
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result1))
    TORCH_INTERNAL_ASSERT(result1.use_count() == expected_fresh_use_count(result1), "function: miopen_batch_norm_backward");
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result2))
    TORCH_INTERNAL_ASSERT(result2.use_count() == expected_fresh_use_count(result2), "function: miopen_batch_norm_backward");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result0, result1, result2 ), grad_fn);
  }
...
at::Tensor mkldnn_convolution(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias, c10::SymIntArrayRef padding, c10::SymIntArrayRef stride, c10::SymIntArrayRef dilation, c10::SymInt groups) {
  ...
  c10::intrusive_ptr<MkldnnConvolutionBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<MkldnnConvolutionBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: mkldnn_convolution");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor mul_Tensor(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & other) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: mul_Tensor");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor mul_Scalar(c10::DispatchKeySet ks, const at::Tensor & self, const at::Scalar & other) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: mul_Scalar");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor multinomial(c10::DispatchKeySet ks, const at::Tensor & self, c10::SymInt num_samples, bool replacement, ::std::optional<at::Generator> generator) {
  ...
  auto _tmp = ([&]() {
    at::AutoDispatchBelowADInplaceOrView guard;
    return at::redispatch::multinomial_symint(ks & c10::after_autograd_keyset, self_, num_samples, replacement, generator);
  })();
  auto result = std::move(_tmp);
  #ifndef NDEBUG
  if (self__storage_saved.has_value() &&
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: multinomial");
  #endif
  return result;
}
at::Tensor & multinomial_out_out(c10::DispatchKeySet ks, const at::Tensor & self, c10::SymInt num_samples, bool replacement, ::std::optional<at::Generator> generator, at::Tensor & out) {
  ...
  {
    at::AutoDispatchBelowAutograd guard;
    at::redispatch::multinomial_symint_outf(ks & c10::after_autograd_keyset, self_, num_samples, replacement, generator, out_);
  }
  #ifndef NDEBUG
  if (self__storage_saved.has_value() &&
      !at::impl::dispatch_mode_enabled() &&
...
at::Tensor mvlgamma(c10::DispatchKeySet ks, const at::Tensor & self, int64_t p) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: mvlgamma");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor new_empty(c10::DispatchKeySet ks, const at::Tensor & self, c10::SymIntArrayRef size, ::std::optional<at::ScalarType> dtype, ::std::optional<at::Layout> layout, ::std::optional<at::Device> device, ::std::optional<bool> pin_memory) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: new_empty");
  #endif
  return result;
}
at::Tensor & nextafter_(c10::DispatchKeySet ks, at::Tensor & self, const at::Tensor & other) {
  ...
  if (_any_has_forward_grad_self && (self.defined())) {
      ...
      auto original_self_t = (original_self_t_raw.defined() || !original_self_tensor.defined())
        ? original_self_t_raw : at::_efficientzerotensor_symint(original_self_tensor.sym_sizes(), original_self_tensor.options());
      auto original_self_p = toNonOptPrimal(original_self);
      self_new_fw_grad_opt = self_t_raw.defined() ? self_t_raw.copy_(at::where(original_self_p != other_p, original_self_t, 0)) : at::where(original_self_p != other_p, original_self_t, 0);
  }
  if (self_new_fw_grad_opt.has_value() && self_new_fw_grad_opt.value().defined() && self.defined()) {
    // The hardcoded 0 here will need to be updated once we support multiple levels.
    self._set_fw_grad(self_new_fw_grad_opt.value(), /* level */ 0, /* is_inplace_op */ true);
...
at::Tensor & normal_(c10::DispatchKeySet ks, at::Tensor & self, double mean, double std, ::std::optional<at::Generator> generator) {
  ...
  check_inplace(self, _any_requires_grad);
  ::std::optional<at::Tensor> original_self;
  c10::intrusive_ptr<NormalBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<NormalBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
...
at::Tensor pixel_unshuffle(c10::DispatchKeySet ks, const at::Tensor & self, int64_t downscale_factor) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<PixelUnshuffleBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<PixelUnshuffleBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: pixel_unshuffle");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor pow_Tensor_Tensor(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & exponent) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: pow_Tensor_Tensor");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor pow_Scalar(c10::DispatchKeySet ks, const at::Scalar & self, const at::Tensor & exponent) {
  ...
  c10::intrusive_ptr<PowBackward2> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<PowBackward2>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: pow_Scalar");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor pow_Tensor_Scalar(c10::DispatchKeySet ks, const at::Tensor & self, const at::Scalar & exponent) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: pow_Tensor_Scalar");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor row_indices(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  if (self__storage_saved.has_value() &&
    ...
    TORCH_INTERNAL_ASSERT(self__storage_saved.value().is_alias_of(result.storage()));
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: row_indices");
  #endif
  return result;
}
at::Tensor segment_reduce(c10::DispatchKeySet ks, const at::Tensor & data, c10::string_view reduce, const ::std::optional<at::Tensor> & lengths, const ::std::optional<at::Tensor> & indices, const ::std::optional<at::Tensor> & offsets, int64_t axis, bool unsafe, const ::std::optional<at::Scalar> & initial) {
  ...
  c10::intrusive_ptr<SegmentReduceBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<SegmentReduceBackward0>();
  ...
  #ifndef NDEBUG
  auto data__storage_saved =
    data_.has_storage() ? ::std::optional<Storage>(data_.storage()) : ::std::nullopt;
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: segment_reduce");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor sparse_mask(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & mask) {
  ...
  c10::intrusive_ptr<SparseMaskBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<SparseMaskBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: sparse_mask");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor special_i1e(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<SpecialI1EBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<SpecialI1EBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_ = SavedVariable(self, false);
  }
  #ifndef NDEBUG
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: special_i1e");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor special_modified_bessel_i1(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: special_modified_bessel_i1");
  #endif
  return result;
}
...
at::Tensor special_shifted_chebyshev_polynomial_w(c10::DispatchKeySet ks, const at::Tensor & x, const at::Tensor & n) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: special_shifted_chebyshev_polynomial_w");
  #endif
  return result;
}
at::Tensor special_shifted_chebyshev_polynomial_w_x_scalar(c10::DispatchKeySet ks, const at::Scalar & x, const at::Tensor & n) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: special_shifted_chebyshev_polynomial_w_x_scalar");
  #endif
  return result;
}
at::Tensor special_shifted_chebyshev_polynomial_w_n_scalar(c10::DispatchKeySet ks, const at::Tensor & x, const at::Scalar & n) {
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: special_shifted_chebyshev_polynomial_w_n_scalar");
  #endif
  return result;
}
::std::vector<at::Tensor> split_Tensor(c10::DispatchKeySet ks, const at::Tensor & self, c10::SymInt split_size, int64_t dim) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<SplitBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<SplitBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->dim = dim;
    grad_fn->self_options = self.options();
    grad_fn->self_sym_sizes = self.sym_sizes().vec();
...
at::Tensor tanh_backward(c10::DispatchKeySet ks, const at::Tensor & grad_output, const at::Tensor & output) {
  ...
  c10::intrusive_ptr<TanhBackwardBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<TanhBackwardBackward0>();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: tanh_backward");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor threshold_backward(c10::DispatchKeySet ks, const at::Tensor & grad_output, const at::Tensor & self, const at::Scalar & threshold) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(grad_output) || isFwGradDefined(self));
  c10::intrusive_ptr<ThresholdBackwardBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ThresholdBackwardBackward0>();
    grad_fn->set_next_edges(collect_next_edges( grad_output, self ));
    grad_fn->self_ = SavedVariable(self, false);
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: threshold_backward");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor to_mkldnn(c10::DispatchKeySet ks, const at::Tensor & self, ::std::optional<at::ScalarType> dtype) {
  ...
  c10::intrusive_ptr<ToMkldnnBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ToMkldnnBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_ = SavedVariable(self, false);
  }
  #ifndef NDEBUG
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: to_mkldnn");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor & tril_out_out(c10::DispatchKeySet ks, const at::Tensor & self, c10::SymInt diagonal, at::Tensor & out) {
  ...
  {
    at::AutoDispatchBelowAutograd guard;
    at::redispatch::tril_symint_outf(ks & c10::after_autograd_keyset, self_, diagonal, out_);
  }
  #ifndef NDEBUG
  if (self__storage_saved.has_value() &&
      !at::impl::dispatch_mode_enabled() &&
...
at::Tensor upsample_trilinear3d(c10::DispatchKeySet ks, const at::Tensor & self, c10::SymIntArrayRef output_size, bool align_corners, ::std::optional<double> scales_d, ::std::optional<double> scales_h, ::std::optional<double> scales_w) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<UpsampleTrilinear3DBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<UpsampleTrilinear3DBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->align_corners = align_corners;
    grad_fn->output_size = output_size.vec();
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: upsample_trilinear3d");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor values(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  c10::intrusive_ptr<ValuesBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ValuesBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self ));
    grad_fn->self_ = SavedVariable(self, false);
  }
  #ifndef NDEBUG
...
at::Tensor vdot(c10::DispatchKeySet ks, const at::Tensor & self, const at::Tensor & other) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self) || isFwGradDefined(other));
  c10::intrusive_ptr<VdotBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<VdotBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self, other ));
    if (grad_fn->should_compute_output(0)) {
      grad_fn->other_ = SavedVariable(other, false);
    }
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: vdot");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor view_as_complex_copy(c10::DispatchKeySet ks, const at::Tensor & self) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self));
  c10::intrusive_ptr<ViewAsComplexBackward0_copy> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<ViewAsComplexBackward0_copy>();
    grad_fn->set_next_edges(collect_next_edges( self ));
  }
  #ifndef NDEBUG
  auto self__storage_saved =
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: view_as_complex_copy");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
at::Tensor where_self(c10::DispatchKeySet ks, const at::Tensor & condition, const at::Tensor & self, const at::Tensor & other) {
  ...
  [[maybe_unused]] auto _any_has_forward_grad_result = (isFwGradDefined(self) || isFwGradDefined(other));
  c10::intrusive_ptr<WhereBackward0> grad_fn;
  if (_any_requires_grad) {
    grad_fn = c10::make_intrusive<WhereBackward0>();
    grad_fn->set_next_edges(collect_next_edges( self, other ));
  ...
  if (!at::impl::dispatch_mode_enabled() && !at::impl::tensor_has_dispatch(result))
    TORCH_INTERNAL_ASSERT(result.use_count() == expected_fresh_use_count(result), "function: where_self");
  #endif
  if (grad_fn) {
      set_history(flatten_tensor_args( result ), grad_fn);
  }
...
m.impl("_flash_attention_forward_no_dropout_inplace", torch::autograd::autogradNotImplementedFallback());
...
m.impl("_foreach_lerp.ScalarList",
       TORCH_FN(VariableType::_foreach_lerp_ScalarList)
);
...
m.impl("_foreach_max.out",
       TORCH_FN(VariableType::_foreach_max_out_out)
);
...
m.impl("_fused_adagrad_",
       TORCH_FN(VariableType::_fused_adagrad_)
);
m.impl("_fused_adagrad_.tensor_lr",
       TORCH_FN(VariableType::_fused_adagrad__tensor_lr)
);
...
m.impl("_fused_sgd.out",
       TORCH_FN(VariableType::_fused_sgd_out_out)
);
m.impl("_fused_sgd.tensor_lr_out",
       TORCH_FN(VariableType::_fused_sgd_out_tensor_lr_out)
);
...
m.impl("_nested_get_lengths", torch::autograd::autogradNotImplementedFallback());
m.impl("_nested_get_offsets", torch::autograd::autogradNotImplementedFallback());
...
m.impl("_padded_dense_to_jagged_forward", torch::autograd::autogradNotImplementedFallback());
m.impl("_philox_uniform.out", torch::autograd::autogradNotImplementedFallback());
...
m.impl("_sparse_semi_structured_apply_dense", torch::autograd::autogradNotImplementedFallback());
...
m.impl("addmm.dtype", torch::autograd::autogradNotImplementedFallback());
m.impl("amin.out",
       TORCH_FN(VariableType::amin_out_out)
);
m.impl("aminmax",
       TORCH_FN(VariableType::aminmax)
);
m.impl("angle.out",
