...
namespace {
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper_Lazy__svd(const at::Tensor & self, bool some, bool compute_uv) {
    // No device check
  // DeviceGuard omitted
  return torch::lazy::LazyNativeFunctions::svd(self, some, compute_uv);
}
} // anonymous namespace
::std::tuple<at::Tensor &,at::Tensor &,at::Tensor &> wrapper_Lazy_U_svd_out(const at::Tensor & self, bool some, bool compute_uv, at::Tensor & U, at::Tensor & S, at::Tensor & V) {
  auto wrapper_Lazy_U_svd_out_tmp = wrapper_Lazy__svd(self, some, compute_uv);
  at::_copy_from_and_resize(std::get<0>(wrapper_Lazy_U_svd_out_tmp), U);
  at::_copy_from_and_resize(std::get<1>(wrapper_Lazy_U_svd_out_tmp), S);
  at::_copy_from_and_resize(std::get<2>(wrapper_Lazy_U_svd_out_tmp), V);
...
namespace {
at::Tensor wrapper_Lazy__tril(const at::Tensor & self, c10::SymInt diagonal) {
    // No device check
  // DeviceGuard omitted
  return torch::lazy::LazyNativeFunctions::tril(self, diagonal.guard_int(__FILE__, __LINE__));
}
} // anonymous namespace
at::Tensor & wrapper_Lazy_out_tril_out(const at::Tensor & self, c10::SymInt diagonal, at::Tensor & out) {
...
at::Tensor & wrapper_Lazy__tril_(at::Tensor & self, c10::SymInt diagonal) {
  auto wrapper_Lazy__tril__tmp = wrapper_Lazy__tril(self, diagonal);
  at::_copy_from(wrapper_Lazy__tril__tmp, self);
  return self;
}
namespace {
at::Tensor wrapper_Lazy__triu(const at::Tensor & self, c10::SymInt diagonal) {
    // No device check
  // DeviceGuard omitted
  return torch::lazy::LazyNativeFunctions::triu(self, diagonal.guard_int(__FILE__, __LINE__));
}
} // anonymous namespace
at::Tensor & wrapper_Lazy_out_triu_out(const at::Tensor & self, c10::SymInt diagonal, at::Tensor & out) {
...
at::Tensor & wrapper_Lazy__triu_(at::Tensor & self, c10::SymInt diagonal) {
...
TORCH_API void RegisterTorchScriptLazyNativeFunctions() {
    ...
    m.impl("svd",
    TORCH_FN(wrapper_Lazy__svd));
    m.impl("svd.U",
    TORCH_FN(wrapper_Lazy_U_svd_out));
    m.impl("t_copy",
