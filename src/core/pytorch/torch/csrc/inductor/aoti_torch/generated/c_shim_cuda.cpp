...
AOTITorchError aoti_torch_cuda__flash_attention_forward_no_dropout_inplace_v2(AtenTensorHandle out, AtenTensorHandle query, AtenTensorHandle key, AtenTensorHandle value, AtenTensorHandle* cum_seq_q, AtenTensorHandle* cum_seq_k, int64_t max_q, int64_t max_k, double dropout_p, int32_t is_causal, int32_t return_debug_mask, double* scale, int64_t* window_size_left, int64_t* window_size_right, AtenTensorHandle* seqused_k, AtenTensorHandle* alibi_slopes, AtenTensorHandle* block_table, int64_t* num_splits, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::_flash_attention_forward_no_dropout_inplace_symint(
...
AOTITorchError aoti_torch_cuda__fused_rms_norm(AtenTensorHandle input, const int64_t* normalized_shape, int64_t normalized_shape_len_, AtenTensorHandle* weight, double* eps, AtenTensorHandle* ret0, AtenTensorHandle* ret1) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::_fused_rms_norm(
            resolve_tensor_dispatch_flags(input), pointer_to_list<int64_t>(normalized_shape, normalized_shape_len_), resolve_tensor_dispatch_flags(weight), pointer_to_optional<double>(eps)
        );
		*ret0 = new_tensor_handle(std::move(std::get<0>(tmp_result)));
		*ret1 = new_tensor_handle(std::move(std::get<1>(tmp_result)));
    });
...
AOTITorchError aoti_torch_cuda__grouped_mm(AtenTensorHandle self, AtenTensorHandle mat2, AtenTensorHandle* offs, AtenTensorHandle* bias, int32_t* out_dtype, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::_grouped_mm(
            resolve_tensor_dispatch_flags(self), resolve_tensor_dispatch_flags(mat2), resolve_tensor_dispatch_flags(offs), resolve_tensor_dispatch_flags(bias), pointer_to_optional<c10::ScalarType>(out_dtype)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda__scaled_dot_product_flash_attention_quantized(AtenTensorHandle query, AtenTensorHandle key, AtenTensorHandle value, AtenTensorHandle* q_descale, AtenTensorHandle* k_descale, AtenTensorHandle* v_descale, double dropout_p, int32_t is_causal, int32_t return_debug_mask, double* scale, AtenTensorHandle* ret0, AtenTensorHandle* ret1, AtenTensorHandle* ret2, AtenTensorHandle* ret3, int64_t* ret4, int64_t* ret5, AtenTensorHandle* ret6, AtenTensorHandle* ret7, AtenTensorHandle* ret8) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::_scaled_dot_product_flash_attention(
            resolve_tensor_dispatch_flags(query), resolve_tensor_dispatch_flags(key), resolve_tensor_dispatch_flags(value), resolve_tensor_dispatch_flags(q_descale), resolve_tensor_dispatch_flags(k_descale), resolve_tensor_dispatch_flags(v_descale), dropout_p, is_causal, return_debug_mask, pointer_to_optional<double>(scale)
        );
		if (ret0) { *ret0 = new_tensor_handle(std::move(std::get<0>(tmp_result))); }
		if (ret1) { *ret1 = new_tensor_handle(std::move(std::get<1>(tmp_result))); }
		if (ret2) { *ret2 = new_tensor_handle(std::move(std::get<2>(tmp_result))); }
...
AOTITorchError aoti_torch_cuda__scaled_grouped_mm(AtenTensorHandle self, AtenTensorHandle mat2, AtenTensorHandle scale_a, AtenTensorHandle scale_b, AtenTensorHandle* offs, AtenTensorHandle* bias, AtenTensorHandle* scale_result, int32_t* out_dtype, int32_t use_fast_accum, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::_scaled_grouped_mm(
...
AOTITorchError aoti_torch_cuda__weight_int4pack_mm(AtenTensorHandle self, AtenTensorHandle mat2, int64_t qGroupSize, AtenTensorHandle qScaleAndZeros, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::_weight_int4pack_mm(
            resolve_tensor_dispatch_flags(self), resolve_tensor_dispatch_flags(mat2), qGroupSize, resolve_tensor_dispatch_flags(qScaleAndZeros)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda__weight_int8pack_mm(AtenTensorHandle self, AtenTensorHandle mat2, AtenTensorHandle scales, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::_weight_int8pack_mm(
...
AOTITorchError aoti_torch_cuda_abs(AtenTensorHandle self, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::abs(
...
AOTITorchError aoti_torch_cuda_fill__Scalar(AtenTensorHandle self, double value) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        at::cuda::fill_(
...
AOTITorchError aoti_torch_cuda_grid_sampler_3d(AtenTensorHandle input, AtenTensorHandle grid, int64_t interpolation_mode, int64_t padding_mode, int32_t align_corners, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::grid_sampler_3d(
            resolve_tensor_dispatch_flags(input), resolve_tensor_dispatch_flags(grid), interpolation_mode, padding_mode, align_corners
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda_grid_sampler_3d_backward(AtenTensorHandle grad_output, AtenTensorHandle input, AtenTensorHandle grid, int64_t interpolation_mode, int64_t padding_mode, int32_t align_corners, const int32_t* output_mask, int64_t output_mask_len_, AtenTensorHandle* ret0, AtenTensorHandle* ret1) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::grid_sampler_3d_backward(
            resolve_tensor_dispatch_flags(grad_output), resolve_tensor_dispatch_flags(input), resolve_tensor_dispatch_flags(grid), interpolation_mode, padding_mode, align_corners, pointer_to_list<2>(output_mask)
        );
		if (ret0) { *ret0 = new_tensor_handle(std::move(std::get<0>(tmp_result))); }
		if (ret1) { *ret1 = new_tensor_handle(std::move(std::get<1>(tmp_result))); }
...
AOTITorchError aoti_torch_cuda_hann_window(int64_t window_length, int32_t* dtype, int32_t* layout, int32_t* device, int32_t device_index_, int32_t* pin_memory, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::hann_window(
            window_length, pointer_to_optional<c10::ScalarType>(dtype), pointer_to_optional<c10::Layout>(layout), pointer_to_optional_device(device, device_index_), pointer_to_optional<bool>(pin_memory)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda_kthvalue(AtenTensorHandle self, int64_t k, int64_t dim, int32_t keepdim, AtenTensorHandle* ret0, AtenTensorHandle* ret1) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::kthvalue_symint(
...
AOTITorchError aoti_torch_cuda_mm_dtype_out(AtenTensorHandle out, AtenTensorHandle self, AtenTensorHandle mat2, int32_t out_dtype) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        at::cuda::mm_out(
            *tensor_handle_to_tensor_pointer(out), resolve_tensor_dispatch_flags(self), resolve_tensor_dispatch_flags(mat2), static_cast<c10::ScalarType>(out_dtype)
        );
...
AOTITorchError aoti_torch_cuda_narrow(AtenTensorHandle self, int64_t dim, int64_t start, int64_t length, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeimplicitautograd::narrow_symint(
...
AOTITorchError aoti_torch_cuda_nonzero_static(AtenTensorHandle self, int64_t size, int64_t fill_value, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::nonzero_static_symint(
            resolve_tensor_dispatch_flags(self), size, fill_value
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda_pad(AtenTensorHandle self, const int64_t* pad, int64_t pad_len_, const char* mode, double* value, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeimplicitautograd::pad_symint(
...
AOTITorchError aoti_torch_cuda_permute(AtenTensorHandle self, const int64_t* dims, int64_t dims_len_, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::permute(
            resolve_tensor_dispatch_flags(self), pointer_to_list<int64_t>(dims, dims_len_)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda_rand_like(AtenTensorHandle self, int32_t* dtype, int32_t* layout, int32_t* device, int32_t device_index_, int32_t* pin_memory, int32_t* memory_format, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::rand_like(
            resolve_tensor_dispatch_flags(self), pointer_to_optional<c10::ScalarType>(dtype), pointer_to_optional<c10::Layout>(layout), pointer_to_optional_device(device, device_index_), pointer_to_optional<bool>(pin_memory), pointer_to_optional<c10::MemoryFormat>(memory_format)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda_rand_like_generator(AtenTensorHandle self, AtenGeneratorHandle* generator, int32_t* dtype, int32_t* layout, int32_t* device, int32_t device_index_, int32_t* pin_memory, int32_t* memory_format, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::rand_like(
            resolve_tensor_dispatch_flags(self), pointer_to_optional<at::Generator>(generator), pointer_to_optional<c10::ScalarType>(dtype), pointer_to_optional<c10::Layout>(layout), pointer_to_optional_device(device, device_index_), pointer_to_optional<bool>(pin_memory), pointer_to_optional<c10::MemoryFormat>(memory_format)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda_randint_like(AtenTensorHandle self, int64_t high, int32_t* dtype, int32_t* layout, int32_t* device, int32_t device_index_, int32_t* pin_memory, int32_t* memory_format, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::randint_like_symint(
            resolve_tensor_dispatch_flags(self), high, pointer_to_optional<c10::ScalarType>(dtype), pointer_to_optional<c10::Layout>(layout), pointer_to_optional_device(device, device_index_), pointer_to_optional<bool>(pin_memory), pointer_to_optional<c10::MemoryFormat>(memory_format)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda_randint_like_low_dtype(AtenTensorHandle self, int64_t low, int64_t high, int32_t* dtype, int32_t* layout, int32_t* device, int32_t device_index_, int32_t* pin_memory, int32_t* memory_format, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::randint_like_symint(
            resolve_tensor_dispatch_flags(self), low, high, pointer_to_optional<c10::ScalarType>(dtype), pointer_to_optional<c10::Layout>(layout), pointer_to_optional_device(device, device_index_), pointer_to_optional<bool>(pin_memory), pointer_to_optional<c10::MemoryFormat>(memory_format)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda_randn_like(AtenTensorHandle self, int32_t* dtype, int32_t* layout, int32_t* device, int32_t device_index_, int32_t* pin_memory, int32_t* memory_format, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::randn_like(
            resolve_tensor_dispatch_flags(self), pointer_to_optional<c10::ScalarType>(dtype), pointer_to_optional<c10::Layout>(layout), pointer_to_optional_device(device, device_index_), pointer_to_optional<bool>(pin_memory), pointer_to_optional<c10::MemoryFormat>(memory_format)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
...
AOTITorchError aoti_torch_cuda_randn_like_generator(AtenTensorHandle self, AtenGeneratorHandle* generator, int32_t* dtype, int32_t* layout, int32_t* device, int32_t device_index_, int32_t* pin_memory, int32_t* memory_format, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::randn_like(
            resolve_tensor_dispatch_flags(self), pointer_to_optional<at::Generator>(generator), pointer_to_optional<c10::ScalarType>(dtype), pointer_to_optional<c10::Layout>(layout), pointer_to_optional_device(device, device_index_), pointer_to_optional<bool>(pin_memory), pointer_to_optional<c10::MemoryFormat>(memory_format)
        );
...
AOTITorchError aoti_torch_cuda_searchsorted_Scalar(AtenTensorHandle sorted_sequence, double self, int32_t out_int32, int32_t right, const char** side, AtenTensorHandle* sorter, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::searchsorted(
            resolve_tensor_dispatch_flags(sorted_sequence), self, out_int32, right, pointer_to_optional<::std::string_view>(side), resolve_tensor_dispatch_flags(sorter)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda_searchsorted_Tensor(AtenTensorHandle sorted_sequence, AtenTensorHandle self, int32_t out_int32, int32_t right, const char** side, AtenTensorHandle* sorter, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::cuda::searchsorted(
            resolve_tensor_dispatch_flags(sorted_sequence), resolve_tensor_dispatch_flags(self), out_int32, right, pointer_to_optional<::std::string_view>(side), resolve_tensor_dispatch_flags(sorter)
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
}
...
AOTITorchError aoti_torch_cuda_squeeze_dim(AtenTensorHandle self, int64_t dim, AtenTensorHandle* ret0) {
    AOTI_TORCH_CONVERT_EXCEPTION_TO_ERROR_CODE({
        auto tmp_result = at::compositeexplicitautograd::squeeze(
            resolve_tensor_dispatch_flags(self), dim
        );
		*ret0 = new_tensor_handle(std::move(tmp_result));
    });
