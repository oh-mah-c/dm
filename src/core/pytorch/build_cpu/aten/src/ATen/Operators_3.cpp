...
static C10_NOINLINE c10::TypedOperatorHandle<_use_miopen_ctc_loss::schema> create__use_miopen_ctc_loss_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_use_miopen_ctc_loss::name, _use_miopen_ctc_loss::overload_name)
      .typed<_use_miopen_ctc_loss::schema>();
}

// aten::_use_miopen_ctc_loss(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank) -> bool
bool _use_miopen_ctc_loss::call(const at::Tensor & log_probs, const at::Tensor & targets, at::IntArrayRef input_lengths, at::IntArrayRef target_lengths, int64_t blank) {

    static auto op = create__use_miopen_ctc_loss_typed_handle();
    return op.call(log_probs, targets, input_lengths, target_lengths, blank);
}

// aten::_use_miopen_ctc_loss(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank) -> bool
bool _use_miopen_ctc_loss::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & log_probs, const at::Tensor & targets, at::IntArrayRef input_lengths, at::IntArrayRef target_lengths, int64_t blank) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_use_miopen_ctc_loss_Tensor::schema> create__use_miopen_ctc_loss_Tensor_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_use_miopen_ctc_loss_Tensor::name, _use_miopen_ctc_loss_Tensor::overload_name)
      .typed<_use_miopen_ctc_loss_Tensor::schema>();
}

// aten::_use_miopen_ctc_loss.Tensor(Tensor log_probs, Tensor targets, Tensor input_lengths, Tensor target_lengths, int blank) -> bool
bool _use_miopen_ctc_loss_Tensor::call(const at::Tensor & log_probs, const at::Tensor & targets, const at::Tensor & input_lengths, const at::Tensor & target_lengths, int64_t blank) {

    static auto op = create__use_miopen_ctc_loss_Tensor_typed_handle();
    return op.call(log_probs, targets, input_lengths, target_lengths, blank);
}

// aten::_use_miopen_ctc_loss.Tensor(Tensor log_probs, Tensor targets, Tensor input_lengths, Tensor target_lengths, int blank) -> bool
bool _use_miopen_ctc_loss_Tensor::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & log_probs, const at::Tensor & targets, const at::Tensor & input_lengths, const at::Tensor & target_lengths, int64_t blank) {
...
static C10_NOINLINE c10::TypedOperatorHandle<miopen_ctc_loss::schema> create_miopen_ctc_loss_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(miopen_ctc_loss::name, miopen_ctc_loss::overload_name)
      .typed<miopen_ctc_loss::schema>();
}

// aten::miopen_ctc_loss(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank, bool deterministic, bool zero_infinity) -> (Tensor, Tensor)
::std::tuple<at::Tensor,at::Tensor> miopen_ctc_loss::call(const at::Tensor & log_probs, const at::Tensor & targets, at::IntArrayRef input_lengths, at::IntArrayRef target_lengths, int64_t blank, bool deterministic, bool zero_infinity) {

    static auto op = create_miopen_ctc_loss_typed_handle();
    return op.call(log_probs, targets, input_lengths, target_lengths, blank, deterministic, zero_infinity);
}

// aten::miopen_ctc_loss(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank, bool deterministic, bool zero_infinity) -> (Tensor, Tensor)
::std::tuple<at::Tensor,at::Tensor> miopen_ctc_loss::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & log_probs, const at::Tensor & targets, at::IntArrayRef input_lengths, at::IntArrayRef target_lengths, int64_t blank, bool deterministic, bool zero_infinity) {
...
static C10_NOINLINE c10::TypedOperatorHandle<miopen_ctc_loss_Tensor::schema> create_miopen_ctc_loss_Tensor_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(miopen_ctc_loss_Tensor::name, miopen_ctc_loss_Tensor::overload_name)
      .typed<miopen_ctc_loss_Tensor::schema>();
}

// aten::miopen_ctc_loss.Tensor(Tensor log_probs, Tensor targets, Tensor input_lengths, Tensor target_lengths, int blank, bool deterministic, bool zero_infinity) -> (Tensor, Tensor)
::std::tuple<at::Tensor,at::Tensor> miopen_ctc_loss_Tensor::call(const at::Tensor & log_probs, const at::Tensor & targets, const at::Tensor & input_lengths, const at::Tensor & target_lengths, int64_t blank, bool deterministic, bool zero_infinity) {

    static auto op = create_miopen_ctc_loss_Tensor_typed_handle();
    return op.call(log_probs, targets, input_lengths, target_lengths, blank, deterministic, zero_infinity);
}

// aten::miopen_ctc_loss.Tensor(Tensor log_probs, Tensor targets, Tensor input_lengths, Tensor target_lengths, int blank, bool deterministic, bool zero_infinity) -> (Tensor, Tensor)
::std::tuple<at::Tensor,at::Tensor> miopen_ctc_loss_Tensor::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & log_probs, const at::Tensor & targets, const at::Tensor & input_lengths, const at::Tensor & target_lengths, int64_t blank, bool deterministic, bool zero_infinity) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_philox_key_fold_in::schema> create__philox_key_fold_in_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_philox_key_fold_in::name, _philox_key_fold_in::overload_name)
      .typed<_philox_key_fold_in::schema>();
}

// aten::_philox_key_fold_in(Tensor key, int data) -> Tensor
at::Tensor _philox_key_fold_in::call(const at::Tensor & key, int64_t data) {

    static auto op = create__philox_key_fold_in_typed_handle();
    return op.call(key, data);
}

// aten::_philox_key_fold_in(Tensor key, int data) -> Tensor
at::Tensor _philox_key_fold_in::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & key, int64_t data) {

    static auto op = create__philox_key_fold_in_typed_handle();
    return op.redispatch(dispatchKeySet, key, data);
}

// aten::_philox_normal_(Tensor(a!) self, Tensor key, float mean=0, float std=1) -> Tensor(a!)
static C10_NOINLINE c10::TypedOperatorHandle<_philox_normal_::schema> create__philox_normal__typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_philox_normal_::name, _philox_normal_::overload_name)
      .typed<_philox_normal_::schema>();
}

// aten::_philox_normal_(Tensor(a!) self, Tensor key, float mean=0, float std=1) -> Tensor(a!)
at::Tensor & _philox_normal_::call(at::Tensor & self, const at::Tensor & key, double mean, double std) {

    static auto op = create__philox_normal__typed_handle();
    return op.call(self, key, mean, std);
}

// aten::_philox_normal_(Tensor(a!) self, Tensor key, float mean=0, float std=1) -> Tensor(a!)
at::Tensor & _philox_normal_::redispatch(c10::DispatchKeySet dispatchKeySet, at::Tensor & self, const at::Tensor & key, double mean, double std) {

    static auto op = create__philox_normal__typed_handle();
    return op.redispatch(dispatchKeySet, self, key, mean, std);
}
...
// aten::_scaled_dot_product_attention_math_for_mps(Tensor query, Tensor key, Tensor value, Tensor? attn_mask=None, float dropout_p=0.0, bool is_causal=False, Tensor? dropout_mask=None, *, float? scale=None, bool enable_gqa=False) -> (Tensor, Tensor)
::std::tuple<at::Tensor,at::Tensor> _scaled_dot_product_attention_math_for_mps::call(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & attn_mask, double dropout_p, bool is_causal, const ::std::optional<at::Tensor> & dropout_mask, ::std::optional<double> scale, bool enable_gqa) {
...
static C10_NOINLINE c10::TypedOperatorHandle<miopen_ctc_loss_out::schema> create_miopen_ctc_loss_out_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(miopen_ctc_loss_out::name, miopen_ctc_loss_out::overload_name)
      .typed<miopen_ctc_loss_out::schema>();
}

// aten::miopen_ctc_loss.out(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank, bool deterministic, bool zero_infinity, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))
::std::tuple<at::Tensor &,at::Tensor &> miopen_ctc_loss_out::call(const at::Tensor & log_probs, const at::Tensor & targets, at::IntArrayRef input_lengths, at::IntArrayRef target_lengths, int64_t blank, bool deterministic, bool zero_infinity, at::Tensor & out0, at::Tensor & out1) {

    static auto op = create_miopen_ctc_loss_out_typed_handle();
    return op.call(log_probs, targets, input_lengths, target_lengths, blank, deterministic, zero_infinity, out0, out1);
}

// aten::miopen_ctc_loss.out(Tensor log_probs, Tensor targets, int[] input_lengths, int[] target_lengths, int blank, bool deterministic, bool zero_infinity, *, Tensor(a!) out0, Tensor(b!) out1) -> (Tensor(a!), Tensor(b!))
::std::tuple<at::Tensor &,at::Tensor &> miopen_ctc_loss_out::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & log_probs, const at::Tensor & targets, at::IntArrayRef input_lengths, at::IntArrayRef target_lengths, int64_t blank, bool deterministic, bool zero_infinity, at::Tensor & out0, at::Tensor & out1) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_philox_normal_out::schema> create__philox_normal_out_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_philox_normal_out::name, _philox_normal_out::overload_name)
      .typed<_philox_normal_out::schema>();
}

// aten::_philox_normal.out(Tensor self, Tensor key, float mean=0, float std=1, *, Tensor(a!) out) -> Tensor(a!)
at::Tensor & _philox_normal_out::call(const at::Tensor & self, const at::Tensor & key, double mean, double std, at::Tensor & out) {

    static auto op = create__philox_normal_out_typed_handle();
    return op.call(self, key, mean, std, out);
}

// aten::_philox_normal.out(Tensor self, Tensor key, float mean=0, float std=1, *, Tensor(a!) out) -> Tensor(a!)
at::Tensor & _philox_normal_out::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & key, double mean, double std, at::Tensor & out) {

    static auto op = create__philox_normal_out_typed_handle();
    return op.redispatch(dispatchKeySet, self, key, mean, std, out);
}

// aten::_philox_normal(Tensor self, Tensor key, float mean=0, float std=1) -> Tensor
static C10_NOINLINE c10::TypedOperatorHandle<_philox_normal::schema> create__philox_normal_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_philox_normal::name, _philox_normal::overload_name)
      .typed<_philox_normal::schema>();
}

// aten::_philox_normal(Tensor self, Tensor key, float mean=0, float std=1) -> Tensor
at::Tensor _philox_normal::call(const at::Tensor & self, const at::Tensor & key, double mean, double std) {

    static auto op = create__philox_normal_typed_handle();
    return op.call(self, key, mean, std);
}

// aten::_philox_normal(Tensor self, Tensor key, float mean=0, float std=1) -> Tensor
at::Tensor _philox_normal::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & key, double mean, double std) {
