...
static C10_NOINLINE c10::TypedOperatorHandle<storage_offset::schema> create_storage_offset_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(storage_offset::name, storage_offset::overload_name)
      .typed<storage_offset::schema>();
}

// aten::storage_offset(Tensor self) -> int
int64_t storage_offset::call(const at::Tensor & self) {

    static auto op = create_storage_offset_typed_handle();
    return op.call(self);
}

// aten::storage_offset(Tensor self) -> int
int64_t storage_offset::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_upsample_lanczos2d_aa_backward_grad_input::schema> create__upsample_lanczos2d_aa_backward_grad_input_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_upsample_lanczos2d_aa_backward_grad_input::name, _upsample_lanczos2d_aa_backward_grad_input::overload_name)
      .typed<_upsample_lanczos2d_aa_backward_grad_input::schema>();
}

// aten::_upsample_lanczos2d_aa_backward.grad_input(Tensor grad_output, SymInt[2] output_size, SymInt[4] input_size, bool align_corners, float? scales_h=None, float? scales_w=None, *, Tensor(a!) grad_input) -> Tensor(a!)
at::Tensor & _upsample_lanczos2d_aa_backward_grad_input::call(const at::Tensor & grad_output, c10::SymIntArrayRef output_size, c10::SymIntArrayRef input_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w, at::Tensor & grad_input) {

    static auto op = create__upsample_lanczos2d_aa_backward_grad_input_typed_handle();
    return op.call(grad_output, output_size, input_size, align_corners, scales_h, scales_w, grad_input);
}

// aten::_upsample_lanczos2d_aa_backward.grad_input(Tensor grad_output, SymInt[2] output_size, SymInt[4] input_size, bool align_corners, float? scales_h=None, float? scales_w=None, *, Tensor(a!) grad_input) -> Tensor(a!)
at::Tensor & _upsample_lanczos2d_aa_backward_grad_input::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & grad_output, c10::SymIntArrayRef output_size, c10::SymIntArrayRef input_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w, at::Tensor & grad_input) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_upsample_lanczos2d_aa_backward::schema> create__upsample_lanczos2d_aa_backward_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_upsample_lanczos2d_aa_backward::name, _upsample_lanczos2d_aa_backward::overload_name)
      .typed<_upsample_lanczos2d_aa_backward::schema>();
}

// aten::_upsample_lanczos2d_aa_backward(Tensor grad_output, SymInt[2] output_size, SymInt[4] input_size, bool align_corners, float? scales_h=None, float? scales_w=None) -> Tensor
at::Tensor _upsample_lanczos2d_aa_backward::call(const at::Tensor & grad_output, c10::SymIntArrayRef output_size, c10::SymIntArrayRef input_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w) {

    static auto op = create__upsample_lanczos2d_aa_backward_typed_handle();
    return op.call(grad_output, output_size, input_size, align_corners, scales_h, scales_w);
}

// aten::_upsample_lanczos2d_aa_backward(Tensor grad_output, SymInt[2] output_size, SymInt[4] input_size, bool align_corners, float? scales_h=None, float? scales_w=None) -> Tensor
at::Tensor _upsample_lanczos2d_aa_backward::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & grad_output, c10::SymIntArrayRef output_size, c10::SymIntArrayRef input_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w) {
