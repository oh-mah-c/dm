...
static C10_NOINLINE c10::TypedOperatorHandle<numel::schema> create_numel_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(numel::name, numel::overload_name)
      .typed<numel::schema>();
}

// aten::numel(Tensor self) -> int
int64_t numel::call(const at::Tensor & self) {

    static auto op = create_numel_typed_handle();
    return op.call(self);
}

// aten::numel(Tensor self) -> int
int64_t numel::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
...
static C10_NOINLINE c10::TypedOperatorHandle<dim::schema> create_dim_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(dim::name, dim::overload_name)
      .typed<dim::schema>();
}

// aten::dim(Tensor self) -> int
int64_t dim::call(const at::Tensor & self) {

    static auto op = create_dim_typed_handle();
    return op.call(self);
}

// aten::dim(Tensor self) -> int
int64_t dim::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_philox_uniform_::schema> create__philox_uniform__typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_philox_uniform_::name, _philox_uniform_::overload_name)
      .typed<_philox_uniform_::schema>();
}

// aten::_philox_uniform_(Tensor(a!) self, Tensor key, float low=0, float high=1) -> Tensor(a!)
at::Tensor & _philox_uniform_::call(at::Tensor & self, const at::Tensor & key, double low, double high) {

    static auto op = create__philox_uniform__typed_handle();
    return op.call(self, key, low, high);
}

// aten::_philox_uniform_(Tensor(a!) self, Tensor key, float low=0, float high=1) -> Tensor(a!)
at::Tensor & _philox_uniform_::redispatch(c10::DispatchKeySet dispatchKeySet, at::Tensor & self, const at::Tensor & key, double low, double high) {

    static auto op = create__philox_uniform__typed_handle();
    return op.redispatch(dispatchKeySet, self, key, low, high);
}
...
static C10_NOINLINE c10::TypedOperatorHandle<_upsample_lanczos2d_aa_vec::schema> create__upsample_lanczos2d_aa_vec_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_upsample_lanczos2d_aa_vec::name, _upsample_lanczos2d_aa_vec::overload_name)
      .typed<_upsample_lanczos2d_aa_vec::schema>();
}

// aten::_upsample_lanczos2d_aa.vec(Tensor input, SymInt[]? output_size, bool align_corners, float[]? scale_factors) -> Tensor
at::Tensor _upsample_lanczos2d_aa_vec::call(const at::Tensor & input, at::OptionalSymIntArrayRef output_size, bool align_corners, ::std::optional<at::ArrayRef<double>> scale_factors) {

    static auto op = create__upsample_lanczos2d_aa_vec_typed_handle();
    return op.call(input, output_size, align_corners, scale_factors);
}

// aten::_upsample_lanczos2d_aa.vec(Tensor input, SymInt[]? output_size, bool align_corners, float[]? scale_factors) -> Tensor
at::Tensor _upsample_lanczos2d_aa_vec::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & input, at::OptionalSymIntArrayRef output_size, bool align_corners, ::std::optional<at::ArrayRef<double>> scale_factors) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_upsample_lanczos2d_aa_out::schema> create__upsample_lanczos2d_aa_out_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_upsample_lanczos2d_aa_out::name, _upsample_lanczos2d_aa_out::overload_name)
      .typed<_upsample_lanczos2d_aa_out::schema>();
}

// aten::_upsample_lanczos2d_aa.out(Tensor self, SymInt[2] output_size, bool align_corners, float? scales_h=None, float? scales_w=None, *, Tensor(a!) out) -> Tensor(a!)
at::Tensor & _upsample_lanczos2d_aa_out::call(const at::Tensor & self, c10::SymIntArrayRef output_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w, at::Tensor & out) {

    static auto op = create__upsample_lanczos2d_aa_out_typed_handle();
    return op.call(self, output_size, align_corners, scales_h, scales_w, out);
}

// aten::_upsample_lanczos2d_aa.out(Tensor self, SymInt[2] output_size, bool align_corners, float? scales_h=None, float? scales_w=None, *, Tensor(a!) out) -> Tensor(a!)
at::Tensor & _upsample_lanczos2d_aa_out::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::SymIntArrayRef output_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w, at::Tensor & out) {
...
static C10_NOINLINE c10::TypedOperatorHandle<_upsample_lanczos2d_aa::schema> create__upsample_lanczos2d_aa_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_upsample_lanczos2d_aa::name, _upsample_lanczos2d_aa::overload_name)
      .typed<_upsample_lanczos2d_aa::schema>();
}

// aten::_upsample_lanczos2d_aa(Tensor self, SymInt[2] output_size, bool align_corners, float? scales_h=None, float? scales_w=None) -> Tensor
at::Tensor _upsample_lanczos2d_aa::call(const at::Tensor & self, c10::SymIntArrayRef output_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w) {

    static auto op = create__upsample_lanczos2d_aa_typed_handle();
    return op.call(self, output_size, align_corners, scales_h, scales_w);
}

// aten::_upsample_lanczos2d_aa(Tensor self, SymInt[2] output_size, bool align_corners, float? scales_h=None, float? scales_w=None) -> Tensor
at::Tensor _upsample_lanczos2d_aa::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, c10::SymIntArrayRef output_size, bool align_corners, ::std::optional<double> scales_h, ::std::optional<double> scales_w) {
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> _flash_attention_forward::call(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & cum_seq_q, const ::std::optional<at::Tensor> & cum_seq_k, c10::SymInt max_q, c10::SymInt max_k, double dropout_p, bool is_causal, bool return_debug_mask, ::std::optional<double> scale, ::std::optional<c10::SymInt> window_size_left, ::std::optional<c10::SymInt> window_size_right, const ::std::optional<at::Tensor> & seqused_k, const ::std::optional<at::Tensor> & alibi_slopes, const ::std::optional<at::Tensor> & block_table, ::std::optional<int64_t> num_splits) {
    ...
    return op.call(query, key, value, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, return_debug_mask, scale, window_size_left, window_size_right, seqused_k, alibi_slopes, block_table, num_splits);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> _flash_attention_forward::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & cum_seq_q, const ::std::optional<at::Tensor> & cum_seq_k, c10::SymInt max_q, c10::SymInt max_k, double dropout_p, bool is_causal, bool return_debug_mask, ::std::optional<double> scale, ::std::optional<c10::SymInt> window_size_left, ::std::optional<c10::SymInt> window_size_right, const ::std::optional<at::Tensor> & seqused_k, const ::std::optional<at::Tensor> & alibi_slopes, const ::std::optional<at::Tensor> & block_table, ::std::optional<int64_t> num_splits) {
    ...
    static auto op = create__flash_attention_forward_typed_handle();
    return op.redispatch(dispatchKeySet, query, key, value, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, return_debug_mask, scale, window_size_left, window_size_right, seqused_k, alibi_slopes, block_table, num_splits);
}
...
static C10_NOINLINE c10::TypedOperatorHandle<_flash_attention_forward_no_dropout_inplace::schema> create__flash_attention_forward_no_dropout_inplace_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_flash_attention_forward_no_dropout_inplace::name, _flash_attention_forward_no_dropout_inplace::overload_name)
      .typed<_flash_attention_forward_no_dropout_inplace::schema>();
}

// aten::_flash_attention_forward_no_dropout_inplace(Tensor(a!) out, Tensor query, Tensor key, Tensor value, Tensor? cum_seq_q, Tensor? cum_seq_k, SymInt max_q, SymInt max_k, float dropout_p, bool is_causal, bool return_debug_mask, *, float? scale=None, SymInt? window_size_left=None, SymInt? window_size_right=None, Tensor? seqused_k=None, Tensor? alibi_slopes=None, Tensor? block_table=None, int? num_splits=None) -> Tensor softmax_logsumexp
at::Tensor _flash_attention_forward_no_dropout_inplace::call(at::Tensor & out, const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & cum_seq_q, const ::std::optional<at::Tensor> & cum_seq_k, c10::SymInt max_q, c10::SymInt max_k, double dropout_p, bool is_causal, bool return_debug_mask, ::std::optional<double> scale, ::std::optional<c10::SymInt> window_size_left, ::std::optional<c10::SymInt> window_size_right, const ::std::optional<at::Tensor> & seqused_k, const ::std::optional<at::Tensor> & alibi_slopes, const ::std::optional<at::Tensor> & block_table, ::std::optional<int64_t> num_splits) {

    static auto op = create__flash_attention_forward_no_dropout_inplace_typed_handle();
    return op.call(out, query, key, value, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, return_debug_mask, scale, window_size_left, window_size_right, seqused_k, alibi_slopes, block_table, num_splits);
}

// aten::_flash_attention_forward_no_dropout_inplace(Tensor(a!) out, Tensor query, Tensor key, Tensor value, Tensor? cum_seq_q, Tensor? cum_seq_k, SymInt max_q, SymInt max_k, float dropout_p, bool is_causal, bool return_debug_mask, *, float? scale=None, SymInt? window_size_left=None, SymInt? window_size_right=None, Tensor? seqused_k=None, Tensor? alibi_slopes=None, Tensor? block_table=None, int? num_splits=None) -> Tensor softmax_logsumexp
at::Tensor _flash_attention_forward_no_dropout_inplace::redispatch(c10::DispatchKeySet dispatchKeySet, at::Tensor & out, const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & cum_seq_q, const ::std::optional<at::Tensor> & cum_seq_k, c10::SymInt max_q, c10::SymInt max_k, double dropout_p, bool is_causal, bool return_debug_mask, ::std::optional<double> scale, ::std::optional<c10::SymInt> window_size_left, ::std::optional<c10::SymInt> window_size_right, const ::std::optional<at::Tensor> & seqused_k, const ::std::optional<at::Tensor> & alibi_slopes, const ::std::optional<at::Tensor> & block_table, ::std::optional<int64_t> num_splits) {

    static auto op = create__flash_attention_forward_no_dropout_inplace_typed_handle();
    return op.redispatch(dispatchKeySet, out, query, key, value, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, return_debug_mask, scale, window_size_left, window_size_right, seqused_k, alibi_slopes, block_table, num_splits);
}
...
static C10_NOINLINE c10::TypedOperatorHandle<_flash_attention_forward_quantized::schema> create__flash_attention_forward_quantized_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_flash_attention_forward_quantized::name, _flash_attention_forward_quantized::overload_name)
      .typed<_flash_attention_forward_quantized::schema>();
}

// aten::_flash_attention_forward.quantized(Tensor query, Tensor key, Tensor value, Tensor? cum_seq_q, Tensor? cum_seq_k, SymInt max_q, SymInt max_k, float dropout_p, bool is_causal, bool return_debug_mask, Tensor? q_descale, Tensor? k_descale, Tensor? v_descale, *, float? scale=None, SymInt? window_size_left=None, SymInt? window_size_right=None, Tensor? seqused_k=None, Tensor? alibi_slopes=None) -> (Tensor output, Tensor softmax_logsumexp, Tensor rng_state, Tensor unused, Tensor debug_attn_mask)
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> _flash_attention_forward_quantized::call(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & cum_seq_q, const ::std::optional<at::Tensor> & cum_seq_k, c10::SymInt max_q, c10::SymInt max_k, double dropout_p, bool is_causal, bool return_debug_mask, const ::std::optional<at::Tensor> & q_descale, const ::std::optional<at::Tensor> & k_descale, const ::std::optional<at::Tensor> & v_descale, ::std::optional<double> scale, ::std::optional<c10::SymInt> window_size_left, ::std::optional<c10::SymInt> window_size_right, const ::std::optional<at::Tensor> & seqused_k, const ::std::optional<at::Tensor> & alibi_slopes) {

    static auto op = create__flash_attention_forward_quantized_typed_handle();
    return op.call(query, key, value, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, return_debug_mask, q_descale, k_descale, v_descale, scale, window_size_left, window_size_right, seqused_k, alibi_slopes);
}

// aten::_flash_attention_forward.quantized(Tensor query, Tensor key, Tensor value, Tensor? cum_seq_q, Tensor? cum_seq_k, SymInt max_q, SymInt max_k, float dropout_p, bool is_causal, bool return_debug_mask, Tensor? q_descale, Tensor? k_descale, Tensor? v_descale, *, float? scale=None, SymInt? window_size_left=None, SymInt? window_size_right=None, Tensor? seqused_k=None, Tensor? alibi_slopes=None) -> (Tensor output, Tensor softmax_logsumexp, Tensor rng_state, Tensor unused, Tensor debug_attn_mask)
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> _flash_attention_forward_quantized::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & cum_seq_q, const ::std::optional<at::Tensor> & cum_seq_k, c10::SymInt max_q, c10::SymInt max_k, double dropout_p, bool is_causal, bool return_debug_mask, const ::std::optional<at::Tensor> & q_descale, const ::std::optional<at::Tensor> & k_descale, const ::std::optional<at::Tensor> & v_descale, ::std::optional<double> scale, ::std::optional<c10::SymInt> window_size_left, ::std::optional<c10::SymInt> window_size_right, const ::std::optional<at::Tensor> & seqused_k, const ::std::optional<at::Tensor> & alibi_slopes) {

    static auto op = create__flash_attention_forward_quantized_typed_handle();
    return op.redispatch(dispatchKeySet, query, key, value, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, return_debug_mask, q_descale, k_descale, v_descale, scale, window_size_left, window_size_right, seqused_k, alibi_slopes);
}
...
static C10_NOINLINE c10::TypedOperatorHandle<_philox_uniform_out::schema> create__philox_uniform_out_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_philox_uniform_out::name, _philox_uniform_out::overload_name)
      .typed<_philox_uniform_out::schema>();
}

// aten::_philox_uniform.out(Tensor self, Tensor key, float low=0, float high=1, *, Tensor(a!) out) -> Tensor(a!)
at::Tensor & _philox_uniform_out::call(const at::Tensor & self, const at::Tensor & key, double low, double high, at::Tensor & out) {

    static auto op = create__philox_uniform_out_typed_handle();
    return op.call(self, key, low, high, out);
}

// aten::_philox_uniform.out(Tensor self, Tensor key, float low=0, float high=1, *, Tensor(a!) out) -> Tensor(a!)
at::Tensor & _philox_uniform_out::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & key, double low, double high, at::Tensor & out) {

    static auto op = create__philox_uniform_out_typed_handle();
    return op.redispatch(dispatchKeySet, self, key, low, high, out);
}

// aten::_philox_uniform(Tensor self, Tensor key, float low=0, float high=1) -> Tensor
static C10_NOINLINE c10::TypedOperatorHandle<_philox_uniform::schema> create__philox_uniform_typed_handle() {
  return c10::Dispatcher::singleton()
      .findSchemaOrThrow(_philox_uniform::name, _philox_uniform::overload_name)
      .typed<_philox_uniform::schema>();
}

// aten::_philox_uniform(Tensor self, Tensor key, float low=0, float high=1) -> Tensor
at::Tensor _philox_uniform::call(const at::Tensor & self, const at::Tensor & key, double low, double high) {

    static auto op = create__philox_uniform_typed_handle();
    return op.call(self, key, low, high);
}

// aten::_philox_uniform(Tensor self, Tensor key, float low=0, float high=1) -> Tensor
at::Tensor _philox_uniform::redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & self, const at::Tensor & key, double low, double high) {
