...
message("Building MSLK for GPU arch: ${PYTORCH_ROCM_ARCH}")

ADD_DEFINITIONS(-DNDEBUG)
# USE_ROCM flag is used inside MSLK C++ code
...
if(HIP_FOUND)
  ...
  find_library(MSLK_HIP_HCC_LIBRARIES ${hip_library_name} HINTS ${ROCM_PATH}/lib)
  ...
  foreach(rocm_arch ${PYTORCH_ROCM_ARCH})
    list(APPEND HIP_HCC_FLAGS --offload-arch=${rocm_arch})
  endforeach()

  set(MSLK_HIP_INCLUDE ${ROCM_PATH}/include ${MSLK_HIP_INCLUDE})
  set(MSLK_HIP_INCLUDE ${hip_INCLUDE_DIRS} $<BUILD_INTERFACE:${PROJECT_SOURCE_DIR}> $<INSTALL_INTERFACE:include> ${MSLK_HIP_INCLUDE})

  hip_include_directories(${MSLK_HIP_INCLUDE} ${ROCRAND_INCLUDE} ${ROCM_SMI_INCLUDE})
