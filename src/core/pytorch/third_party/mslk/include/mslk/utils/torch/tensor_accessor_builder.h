...
#include <ATen/ATen.h>
#include <mslk/utils/torch/tensor_accessor.h>
...
#ifdef MSLK_MEMCHECK
      return mslk::utils::TensorAccessor<T, N, PtrTraits, index_t>(
...
#ifdef MSLK_MEMCHECK
    return mslk::utils::PackedTensorAccessor<T, N, PtrTraits, index_t>(
        static_cast<typename PtrTraits<T>::PtrType>(tensor.data_ptr<T>()),
        tensor.sizes().data(),
        tensor.strides().data(),
        name.data(),
...
// for backward compatibility and will be removed once all MSLK kernels are
// migrated over to use the MSLK_LAUNCH_KERNEL macro.
//////////////////////////////////////////////////////////////////////////////
