...
#define _MSLK_DSA_FILESRC_ "[" __TEMPLATE_SOURCE_FILE__ "] " __FILE__
#else
#define _MSLK_DSA_FILESRC_ __FILE__
#endif
...
#ifdef __TEMPLATE_SOURCE_FILE__
#define _MSLK_TFILE_ __TEMPLATE_SOURCE_FILE__
#else
#define _MSLK_TFILE_ ""
#endif
...
#define SOURCE_CONTEXT_CURRENT(LABEL)          \
  mslk::utils::SourceContext(                  \
      mslk::utils::source_location::current(), \
      #LABEL,                                  \
      _MSLK_TFILE_,                            \
      _MSLK_DSA_FILESRC_)
