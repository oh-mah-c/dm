...
// that are used in MSLK for additional bounds checks that are not available in
// the standard ATen implementation. Using the builder macro MAKE_TA_WITH_NAME
// and MAKE_PTA_WITH_NAME, bounds checks can be enabled using the MSLK_MEMCHECK
// flag.
//
...
//
// Select mslk::utils::*TensorAccessor or at::*TensorAccessor based on
// MSLK_MEMCHECK flag
////////////////////////////////////////////////////////////////////////////////

#ifdef MSLK_MEMCHECK
namespace pta = mslk::utils;
#else
namespace pta = at;
template <
    typename T,
